...
Embedded text input is enabled by default when your app targets and is running on RS4 or later. To disable the feature and revert to a text input panel, you can set the <TBD API>.
