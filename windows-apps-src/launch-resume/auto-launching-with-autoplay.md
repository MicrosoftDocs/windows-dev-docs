...
> **Note**  If you are a device manufacturer and you want to associate your [Microsoft Store device app](https://msdn.microsoft.com/library/windows/hardware/Dn265154(v=vs.85).aspx) as an **AutoPlay** handler for your device, you can identify that app in the device metadata. For more info, see [AutoPlay for Microsoft Store device apps](https://msdn.microsoft.com/library/windows/hardware/dn265136(v=vs.85).aspx).
