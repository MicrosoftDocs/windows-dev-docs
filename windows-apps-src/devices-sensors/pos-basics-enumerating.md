...
description: Learn how to define a device selector and walk through four methods for using it to query and enumerate the PointOfService devices avilable to your system.
ms.date: 10/08/2018
ms.topic: article
