...
> The value of the Extended Properties descriptor is determined via the ReliableWrites and WritableAuxiliaries characteristic properties.  This descriptor is readable without authentication and authorization being required.

> Note that broadcast is not supported at this time.
