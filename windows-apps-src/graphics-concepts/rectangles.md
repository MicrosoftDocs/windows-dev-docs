...
Most applications use the [**RECT**](https://docs.microsoft.com/previous-versions/dd162897(v=vs.85)) structure (or a typedef'd alias for it) to carry information about a bounding rectangle to use when blitting to the screen or when performing hit detection. In C++, the **RECT** structure has the following definition.
