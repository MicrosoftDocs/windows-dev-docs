...
description: Use this method in the Windows Store analytics API to get aggregate error reporting data for Windows 10 drivers for a given date range and other optional filters. This method is intended only for IHVs.
