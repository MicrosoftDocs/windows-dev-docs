...
Use this method in the Windows Store purchase API to change the billing state of a subscription add-on for a given user. You can cancel, extend, or refund a subscription, or toggle the setting not to automatically renew the subscription at the end of the subscription period.
