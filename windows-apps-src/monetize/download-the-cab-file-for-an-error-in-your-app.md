...
author: mcleanbyron
ms.assetid:
description: Use this method in the Windows Store analytics API to download the CAB file for an error in your app.
...
<!-- IMPORTANT!!!: Do not publish this article unless/until amaziak gives the go-ahead to do so. -->
