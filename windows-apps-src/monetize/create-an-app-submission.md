...
* Make sure the app already has at least one submission with the [age ratings](https://docs.microsoft.com/windows/uwp/publish/age-ratings) information completed.
...
|---------------|--------|-----------------------------------------------------------------------------|
| applicationId | string | Required. The Store ID of the app for which you want to create a submission. For more information about the Store ID, see [View app identity details](https://docs.microsoft.com/windows/uwp/publish/view-app-identity-details).  |
