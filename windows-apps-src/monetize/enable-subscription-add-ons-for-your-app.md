...
* Renewing existing subscriptions after setting the visibility of your subscription add-on to **Stop acquisition** or submitting an app update that removes the subscription from your product. See [Set add-on pricing and availability](../publish/set-add-on-pricing-and-availability.md) for more details.
