...
4. If you are adding new icons for the submission, [prepare the icons](https://docs.microsoft.com/windows/uwp/publish/create-iap-descriptions) and add them to a ZIP archive.
