---
author: mcleanbyron
description: Use the Python code examples in this section to learn more about submitting game options and trailers using the Windows Store submission API.
...
ms.prod: windows
ms.technology: uwp
keywords: windows 10, uwp, Windows Store submission API, code examples, game options, trailers, advanced listings, python
---
...
This code calls other example classes and functions to use the Windows Store submission API to create and commit an app submission that contains game options and a trailer. To adapt this code for your own use:
