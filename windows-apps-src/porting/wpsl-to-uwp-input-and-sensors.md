---
description: Learn how to port Windows Phone Silverlight to UWP for I/O, device, and app model.
...
| **ApplicationPeakMemoryUsage** property                                                 | Use the memory profiling tools in Visual Studio. For more info, see [Measure memory usage](/visualstudio/profiling/memory-usage).                                                                                                                                                                          |
