...
For more info about navigation, see [Navigation](https://docs.microsoft.com/windows/uwp/layout/navigation-basics) and [XAML personality animations sample](https://go.microsoft.com/fwlink/p/?LinkID=242401).
