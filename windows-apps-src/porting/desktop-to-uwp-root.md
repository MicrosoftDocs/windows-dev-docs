...
:heavy_check_mark: Validates your application against packaged desktop application and Microsoft Store requirements.
...
See [Package a desktop application using the Desktop App Converter](desktop-to-uwp-run-desktop-app-converter.md)
...
The [FireGiant Appx extension](https://www.firegiant.com/products/wix-expansion-pack/appx) lets you create Windows app packages and MSI packages simultaneously from the same WiX source code. Every time you build, you can target Windows 10 with a Windows app package and earlier versions of Windows with MSI.
...
See [Integrate your packaged desktop application with Windows 10](desktop-to-uwp-extensions.md).
...
To give your application the best chance of being published on the Microsoft Store or becoming [Windows Certified](http://go.microsoft.com/fwlink/p/?LinkID=309666), validate and test it locally before you submit it for certification.
...
If you're using Visual Studio, you can validate your application from the **Create App Packages** wizard. See [Create an app package upload file](../packaging/packaging-uwp-apps.md#create-an-app-package-upload-file).
...
See [Distribute a packaged desktop app](desktop-to-uwp-distribute.md).
...
| [Package an app using the Desktop App Converter](desktop-to-uwp-run-desktop-app-converter.md) | Shows how to run Desktop App Converter. |
| [Package a desktop application manually](desktop-to-uwp-manual-conversion.md) | Learn how to create an app package and manifest to by hand. |
| [Package a desktop application using Visual Studio](desktop-to-uwp-packaging-dot-net.md)| Shows you how to package your desktop application by using Visual Studio. |
| [Integrate your desktop application with Windows 10](desktop-to-uwp-extensions.md) | Integrate your application with Windows 10 by using by describing tasks in the package manifest file of your packaging project. |
...
| [UWP APIs available to a packaged desktop application](desktop-to-uwp-supported-api.md) | See what UWP APIs are available for your packaged desktop application to use. |
| [Extend your desktop application with modern UWP components](desktop-to-uwp-extend.md)| Add advanced experiences that must run within a UWP app container. Connect your desktop application with the UWP process by using app services.|
| [Run, debug, and test a packaged desktop application](desktop-to-uwp-debug.md) | Explains options for debugging your packaged app. |
| [Distribute a packaged desktop application ](desktop-to-uwp-distribute.md) | See how you can distribute your converted application to users.  |
