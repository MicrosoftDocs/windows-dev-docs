...
-   [Add a MapIcon to the map](#add-a-mapicon) to display an image such as a pushpin with optional text.
-   [Add a MapPolygon to the map](#add-a-mappolygon) to display a multi-point shape.
-   [Add a MapPolyline to the map](#add-a-mappolyline) to display lines on the map.
-   [Add XAML to the map](#add-xaml) to display custom UI elements.
