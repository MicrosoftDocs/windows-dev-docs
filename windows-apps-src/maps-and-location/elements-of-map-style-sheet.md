...
| >> userBillboard             | [MapElement](#mapelement) | The styling for default [MapBillboard](mapbillboard.md) instances. |
| >> userLine                  | [MapElement](#mapelement) | The styling for default [MapPolyline](mappolyline.md) instances. |
| >> userModel3D               | [MapElement](#mapelement) | The styling for default [MapModel3D](mapmodel3d.md) instances.  This is primarily for setting renderAsSurface. |
| >> userPoint                 | [PointStyle](#pointstyle) | The styling for default [MapIcon](mapicon.md) instances. |
