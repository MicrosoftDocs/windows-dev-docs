...
keywords: what's new, whats new, updates, Windows 10, 1710, fall, creators, apis
ms.author: quradic
ms.date: 10/10/2017
ms.topic: article
ms.prod: windows
...
# New APIs in Windows 10 version 1710

New and updated API namespaces have been made available to developers in Windows 10 version 1710, also known as the Creators Update. Below is a full list of documentation published for namespaces added or modified in this release.
