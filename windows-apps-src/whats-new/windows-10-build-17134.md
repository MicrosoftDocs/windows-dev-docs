...
Windows Mixed Reality docs | The Windows Mixed Reality developer guidance is [now hosted on Microsoft Docs](/windows/mixed-reality/). Just like in these UWP docs, you can now file feedback with GitHub Issues or submit your own contributions via a pull request.
