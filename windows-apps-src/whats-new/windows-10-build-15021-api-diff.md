...
# New APIs in the Windows 10 SDK Preview Build 15021

New and updated API namespaces have been made available to [Windows Insiders](https://insider.windows.com/) in the Windows 10 SDK Preview Build 15021. For the first time, prerelease documentation for those namespaces has been published. Please note that prerelease documentation may be incomplete and subject to change.

Below is a full list of prelease documentation published for namespaces added or modified since the last public Windows 10 release, [Version 1607](windows-10-version-1607-api-diff.md).
...
[windows.applicationmodel.preview.inkworkspace](https://docs.microsoft.com/uwp/api/windows.applicationmodel.preview.inkworkspace)
...
[windows.applicationmodel.preview.notes](https://docs.microsoft.com/uwp/api/windows.applicationmodel.preview.notes)
...
[windows.applicationmodel.store.licensemanagement](https://docs.microsoft.com/uwp/api/windows.applicationmodel.store.licensemanagement)
...
[windows.applicationmodel.userdataaccounts](https://docs.microsoft.com/uwp/api/windows.applicationmodel.userdataaccounts)
...
[windows.applicationmodel.userdatatasks.dataprovider](https://docs.microsoft.com/uwp/api/windows.applicationmodel.userdatatasks.dataprovider)
...
[windows.applicationmodel.userdatatasks](https://docs.microsoft.com/uwp/api/windows.applicationmodel.userdatatasks)
...
bluetoothadapter <br> bluetoothadapter.bluetoothaddress <br> bluetoothadapter.deviceid <br> bluetoothadapter.fromidasync <br> bluetoothadapter.getdefaultasync <br> bluetoothadapter.getdeviceselector <br> bluetoothadapter.getradioasync <br> bluetoothadapter.isadvertisementoffloadsupported <br> bluetoothadapter.iscentralrolesupported <br> bluetoothadapter.isclassicsupported <br> bluetoothadapter.islowenergysupported <br> bluetoothadapter.isperipheralrolesupported <br> bluetoothdeviceid <br> bluetoothdeviceid.id <br> bluetoothdeviceid.isclassicdevice <br> bluetoothdeviceid.islowenergydevice <br> bluetoothledevice.deviceaccessinformation <br> bluetoothledevice.getgattservicesasync <br> bluetoothledevice.getgattservicesasync <br> bluetoothledevice.getgattservicesforuuidasync <br> bluetoothledevice.getgattservicesforuuidasync <br> bluetoothledevice.requestaccessasync <br> bluetoothuuidhelper <br> bluetoothuuidhelper.fromshortid <br> bluetoothuuidhelper.trygetshortid <br> 
...
featureattribute <br> featureattribute.featureattribute <br> featurestage <br> 

**Namespace**

[windows.gaming.input.custom](https://docs.microsoft.com/uwp/api/windows.gaming.input.custom)
...
[windows.gaming.input.preview](https://docs.microsoft.com/uwp/api/windows.gaming.input.preview)

**Properties**

gamecontrollerproviderinfo <br> gamecontrollerproviderinfo.getparentproviderid <br> gamecontrollerproviderinfo.getproviderid <br> windows.gaming.input.preview <br> 
...
gamechatmessageorigin <br> gamechatmessagereceivedeventargs <br> gamechatmessagereceivedeventargs.appdisplayname <br> gamechatmessagereceivedeventargs.appid <br> gamechatmessagereceivedeventargs.message <br> gamechatmessagereceivedeventargs.origin <br> gamechatmessagereceivedeventargs.sendername <br> gamechatoverlay <br> gamechatoverlay.addmessage <br> gamechatoverlay.desiredposition <br> gamechatoverlay.getdefault <br> gamechatoverlaymessagesource <br> gamechatoverlaymessagesource.gamechatoverlaymessagesource <br> gamechatoverlaymessagesource.messagereceived <br> gamechatoverlaymessagesource.setdelaybeforeclosingaftermessagereceived <br> gamechatoverlayposition <br> 
...
charactergroupings.charactergroupings <br> 
...
hdmidisplaycolorspace <br> hdmidisplayhdr2086metadata <br> hdmidisplayhdroption <br> hdmidisplayinformation <br> hdmidisplayinformation.displaymodeschanged <br> hdmidisplayinformation.getcurrentdisplaymode <br> hdmidisplayinformation.getforcurrentview <br> hdmidisplayinformation.getsupporteddisplaymodes <br> hdmidisplayinformation.requestsetcurrentdisplaymodeasync <br> hdmidisplayinformation.requestsetcurrentdisplaymodeasync <br> hdmidisplayinformation.requestsetcurrentdisplaymodeasync <br> hdmidisplayinformation.setdefaultdisplaymodeasync <br> hdmidisplaymode <br> hdmidisplaymode.bitsperpixel <br> hdmidisplaymode.colorspace <br> hdmidisplaymode.is2086metadatasupported <br> hdmidisplaymode.isequal <br> hdmidisplaymode.issdrluminancesupported <br> hdmidisplaymode.issmpte2084supported <br> hdmidisplaymode.pixelencoding <br> hdmidisplaymode.refreshrate <br> hdmidisplaymode.resolutionheightinrawpixels <br> hdmidisplaymode.resolutionwidthinrawpixels <br> hdmidisplaymode.stereoenabled <br> hdmidisplaypixelencoding <br> windows.graphics.display.core <br> 
...
[windows.internal.legacylivetile](https://docs.microsoft.com/uwp/api/windows.internal.legacylivetile)

**Properties**

legacylivetileintervalkind <br> legacylivetilerecurrencetype <br> windows.internal.legacylivetile <br> winrtlegacylivetilejobmanager <br> winrtlegacylivetilejobmanager.addlivetilerequest <br> winrtlegacylivetilejobmanager.addlivetileschedule <br> winrtlegacylivetilejobmanager.pushupdatetile <br> winrtlegacylivetilejobmanager.removelegacylivetilesubscription <br> winrtlegacylivetilejobmanager.winrtlegacylivetilejobmanager <br> 
...
deploymentresult.isregistered <br> packagemanager.addpackageasync <br> packagemanager.debugsettings <br> packagemanager.registerpackagebyfamilynameasync <br> packagemanager.stagepackageasync <br> packagemanagerdebugsettings <br> packagemanagerdebugsettings.setcontentgroupstateasync <br> packagemanagerdebugsettings.setcontentgroupstateasync <br> 

**Namespace**

[windows.management.policies](https://docs.microsoft.com/uwp/api/windows.management.policies)

**Properties**

namedpolicy <br> namedpolicy.getpolicyfrompath <br> namedpolicy.getpolicyfrompathforuser <br> namedpolicydata <br> namedpolicydata.area <br> namedpolicydata.changed <br> namedpolicydata.getbinary <br> namedpolicydata.getboolean <br> namedpolicydata.getint32 <br> namedpolicydata.getint64 <br> namedpolicydata.getstring <br> namedpolicydata.ismanaged <br> namedpolicydata.isuserpolicy <br> namedpolicydata.kind <br> namedpolicydata.name <br> namedpolicydata.user <br> namedpolicykind <br> windows.management.policies <br> 

**Namespace**

[windows.management](https://docs.microsoft.com/uwp/api/windows.management)

**Properties**

mdmalert <br> mdmalert.data <br> mdmalert.format <br> mdmalert.mark <br> mdmalert.mdmalert <br> mdmalert.source <br> mdmalert.status <br> mdmalert.target <br> mdmalert.type <br> mdmalertdatatype <br> mdmalertmark <br> mdmsession <br> mdmsession.alerts <br> mdmsession.attachasync <br> mdmsession.delete <br> mdmsession.extendederror <br> mdmsession.id <br> mdmsession.startasync <br> mdmsession.startasync <br> mdmsession.state <br> mdmsessionmanager <br> mdmsessionmanager.deletesessionbyid <br> mdmsessionmanager.getsessionbyid <br> mdmsessionmanager.sessionids <br> mdmsessionmanager.trycreatesession <br> mdmsessionstate <br> windows.management <br> 
...
[windows.media.core.preview](https://docs.microsoft.com/uwp/api/windows.media.core.preview)
...
[windows.perception.spatial.surfaces](https://docs.microsoft.com/uwp/api/windows.perception.spatial.surfaces)
...
[windows.services.maps.offlinemaps](https://docs.microsoft.com/uwp/api/windows.services.maps.offlinemaps)
...
[windows.services.targetedcontent](https://docs.microsoft.com/uwp/api/windows.services.targetedcontent)
...
knownremotesystemcapabilities <br> knownremotesystemcapabilities.appservice <br> knownremotesystemcapabilities.launchuri <br> knownremotesystemcapabilities.remotesession <br> knownremotesystemcapabilities.spatialentity <br> remotesystem.getcapabilitysupportedasync <br> remotesystem.isauthorizationkindenabled <br> remotesystem.isavailablebyspatialproximity <br> remotesystemauthorizationkind <br> remotesystemauthorizationkindfilter <br> remotesystemauthorizationkindfilter.remotesystemauthorizationkind <br> remotesystemauthorizationkindfilter.remotesystemauthorizationkindfilter <br> remotesystemsession <br> remotesystemsession.close <br> remotesystemsession.controllerdisplayname <br> remotesystemsession.createparticipantwatcher <br> remotesystemsession.createwatcher <br> remotesystemsession.disconnected <br> remotesystemsession.displayname <br> remotesystemsession.id <br> remotesystemsession.sendinvitationasync <br> remotesystemsessionaddedeventargs <br> remotesystemsessionaddedeventargs.sessioninfo <br> remotesystemsessioncontroller <br> remotesystemsessioncontroller.createsessionasync <br> remotesystemsessioncontroller.joinrequested <br> remotesystemsessioncontroller.remotesystemsessioncontroller <br> remotesystemsessioncontroller.remotesystemsessioncontroller <br> remotesystemsessioncontroller.removeparticipantasync <br> remotesystemsessioncreationresult <br> remotesystemsessioncreationresult.session <br> remotesystemsessioncreationresult.status <br> remotesystemsessioncreationstatus <br> remotesystemsessiondisconnectedeventargs <br> remotesystemsessiondisconnectedeventargs.reason <br> remotesystemsessiondisconnectedreason <br> remotesystemsessioninfo <br> remotesystemsessioninfo.controllerdisplayname <br> remotesystemsessioninfo.displayname <br> remotesystemsessioninfo.joinasync <br> remotesystemsessioninvitation <br> remotesystemsessioninvitation.sender <br> remotesystemsessioninvitation.sessioninfo <br> remotesystemsessioninvitationlistener <br> remotesystemsessioninvitationlistener.invitationreceived <br> remotesystemsessioninvitationlistener.remotesystemsessioninvitationlistener <br> remotesystemsessioninvitationreceivedeventargs <br> remotesystemsessioninvitationreceivedeventargs.invitation <br> remotesystemsessionjoinrequest <br> remotesystemsessionjoinrequest.accept <br> remotesystemsessionjoinrequest.participant <br> remotesystemsessionjoinrequestedeventargs <br> remotesystemsessionjoinrequestedeventargs.getdeferral <br> remotesystemsessionjoinrequestedeventargs.joinrequest <br> remotesystemsessionjoinresult <br> remotesystemsessionjoinresult.session <br> remotesystemsessionjoinresult.status <br> remotesystemsessionjoinstatus <br> remotesystemsessionmessagechannel <br> remotesystemsessionmessagechannel.broadcastvaluesetasync <br> remotesystemsessionmessagechannel.remotesystemsessionmessagechannel <br> remotesystemsessionmessagechannel.remotesystemsessionmessagechannel <br> remotesystemsessionmessagechannel.sendvaluesetasync <br> remotesystemsessionmessagechannel.sendvaluesettoparticipantsasync <br> remotesystemsessionmessagechannel.session <br> remotesystemsessionmessagechannel.valuesetreceived <br> remotesystemsessionmessagechannelreliability <br> remotesystemsessionoptions <br> remotesystemsessionoptions.isinviteonly <br> remotesystemsessionoptions.remotesystemsessionoptions <br> remotesystemsessionparticipant <br> remotesystemsessionparticipant.gethostnames <br> remotesystemsessionparticipant.remotesystem <br> remotesystemsessionparticipantaddedeventargs <br> remotesystemsessionparticipantaddedeventargs.participant <br> remotesystemsessionparticipantremovedeventargs <br> remotesystemsessionparticipantremovedeventargs.participant <br> remotesystemsessionparticipantwatcher <br> remotesystemsessionparticipantwatcher.added <br> remotesystemsessionparticipantwatcher.enumerationcompleted <br> remotesystemsessionparticipantwatcher.removed <br> remotesystemsessionparticipantwatcher.start <br> remotesystemsessionparticipantwatcher.status <br> remotesystemsessionparticipantwatcher.stop <br> remotesystemsessionparticipantwatcherstatus <br> remotesystemsessionremovedeventargs <br> remotesystemsessionremovedeventargs.sessioninfo <br> remotesystemsessionupdatedeventargs <br> remotesystemsessionupdatedeventargs.sessioninfo <br> remotesystemsessionvaluesetreceivedeventargs <br> remotesystemsessionvaluesetreceivedeventargs.message <br> remotesystemsessionvaluesetreceivedeventargs.sender <br> remotesystemsessionwatcher <br> remotesystemsessionwatcher.added <br> remotesystemsessionwatcher.removed <br> remotesystemsessionwatcher.start <br> remotesystemsessionwatcher.status <br> remotesystemsessionwatcher.stop <br> remotesystemsessionwatcher.updated <br> remotesystemsessionwatcherstatus <br> 
...
diagnosticssettings <br> diagnosticssettings.canusediagnosticstotailorexperiences <br> diagnosticssettings.getdefault <br> diagnosticssettings.getforuser <br> diagnosticssettings.user <br> 
...
systemnavigationcloserequestedprevieweventargs <br> systemnavigationcloserequestedprevieweventargs.getdeferral <br> systemnavigationcloserequestedprevieweventargs.handled <br> systemnavigationmanagerpreview <br> systemnavigationmanagerpreview.closerequested <br> systemnavigationmanagerpreview.getforcurrentview <br> windows.ui.core.preview <br> 
...
[windows.ui.xaml.media.imaging](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.imaging)
