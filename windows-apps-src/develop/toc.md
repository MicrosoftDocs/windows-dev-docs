...
##### [Create an experiment project in Partner Center](../monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
##### [Code your app for experimentation](../monetize/code-your-experiment-in-your-app.md)
##### [Define your experiment in Partner Center](../monetize/define-your-experiment-in-the-dev-center-dashboard.md)
##### [Manage your experiment in Partner Center](../monetize/manage-your-experiment.md)
...
#### [Log custom events for Partner Center](../monetize/log-custom-events-for-dev-center.md)
...
### [Get started](../cpp-and-winrt-apis/get-started.md)
### [What's new](../cpp-and-winrt-apis/news.md)
### [Frequently-asked questions](../cpp-and-winrt-apis/faq.md)
### [Troubleshooting](../cpp-and-winrt-apis/troubleshooting.md)
### [Photo Editor sample application](../cpp-and-winrt-apis/photo-editor-sample.md)
### [String handling](../cpp-and-winrt-apis/strings.md)
### [Standard C++ data types](../cpp-and-winrt-apis/std-cpp-data-types.md)
### [Boxing and unboxing scalar values to IInspectable](../cpp-and-winrt-apis/boxing.md)
### [Consume APIs](../cpp-and-winrt-apis/consume-apis.md)
### [Author APIs](../cpp-and-winrt-apis/author-apis.md)
### [Error handling](../cpp-and-winrt-apis/error-handling.md)
...
### [XAML controls; bind to a property](../cpp-and-winrt-apis/binding-property.md)
### [XAML items controls; bind to a collection](../cpp-and-winrt-apis/binding-collection.md)
...
#### [Configure a barcode scanner](../devices-sensors/pos-barcodescanner-configure.md)
#### [Use a software trigger](../devices-sensors/pos-barcodescanner-software-trigger.md)
#### [Working with symbologies](../devices-sensors/pos-barcodescanner-symbologies.md)
#### [Obtain and understand barcode data](../devices-sensors/pos-barcodescanner-scan-data.md)
...
#### [User Activities best practices](../launch-resume/useractivities-best-practices.md)
