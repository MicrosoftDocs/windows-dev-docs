...
You can use Windows Runtime Composition APIs (also called the [Visual layer](visual-layer.md)) in your Windows Forms apps to create modern experiences that light up for Windows 10 users.
...
![The running app UI](images/interop/wf-comp-interop-app-ui.png)
