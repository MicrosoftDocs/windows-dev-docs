...
You can use Windows Runtime Composition APIs (also called the [Visual layer](visual-layer.md)) in your Win32 apps to create modern experiences that light up for Windows 10 users.
...
![The running app UI](images/interop/win32-comp-interop-app-ui.png)
...
(For details, see [Get started with C++/WinRT - Modify a Windows Desktop application project to add C++/WinRT support](../cpp-and-winrt-apis/get-started.md#modify-a-windows-desktop-application-project-to-add-cwinrt-support)).
...
1. Update the precompiled header
    ...
    - Find and replace `#include "stdafx.h"` with `#include "pch.h"` in all files.
        ...
        ![Find and replace stdafx.h](images/interop/replace-stdafx.png)
