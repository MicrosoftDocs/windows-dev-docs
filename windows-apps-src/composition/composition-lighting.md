...
See the complete [Text Shimmer](https://github.com/microsoft/WindowsCompositionSamples/blob/master/SampleGallery/Samples/SDK%2014393/TextShimmer/TextShimmer.xaml) sample at the WindowUIDevLabs Sample Galley to learn more.
