...
Full example code can be found on the [Windows UI Github repo](https://github.com/microsoft/WindowsCompositionSamples/blob/master/SampleGallery/Samples/SDK%2015063/CompCapabilities/CompCapabilities.xaml).
