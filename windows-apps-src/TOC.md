...
#### [Content transform](style/content-transition-animations.md)
#### [Drag and drop](style/motion-dragdrop.md)
#### [Edge-based](style/motion-edgebased.md)
#### [Fade](style/motion-fade.md)
#### [List](style/motion-list.md)
#### [Popup](style/motion-popup-animations.md)
#### [Reposition](style/motion-reposition.md)
...
#### [Prepare to convert](porting/desktop-to-uwp-prepare.md)
#### [Convert using the Desktop App Converter](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Convert using Visual Studio](porting/desktop-to-uwp-packaging-dot-net.md)
#### [Convert manually](porting/desktop-to-uwp-manual-conversion.md)
#### [App extensions](porting/desktop-to-uwp-extensions.md)
#### [UWP APIs](porting/desktop-to-uwp-supported-api.md)
