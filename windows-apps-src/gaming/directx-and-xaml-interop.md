...
5.  Call [**ISurfaceImageSourceNative::EndDraw**](https://msdn.microsoft.com/library/windows/desktop/hh848324) to complete the bitmap. The bitmap can be used as a source for a XAML [**Image**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.image.aspx) or [**ImageBrush**](https://msdn.microsoft.com/library/windows/apps/br210101).
