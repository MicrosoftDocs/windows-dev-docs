...
|-----------------|---------------|
| [Application data sample](https://docs.microsoft.com/en-us/samples/microsoft/windows-universal-samples/applicationdata/) | Shows  how to store and retrieve data that is specific to each user by using the application data APIs. |
...
| [File picker sample](https://docs.microsoft.com/en-us/samples/microsoft/windows-universal-samples/filepicker/) | Shows how to access files and folders by letting the user choose them with UI, and how to save a file so that the user can specify the name, file type, and location of a file to save. |
