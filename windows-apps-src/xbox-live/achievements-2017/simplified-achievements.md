...
2.  **Must use August 2016 XDK or newer.** The API needed to make use of Simplified Achievements system will be released for the first time in the August XDK. Although the services will be in preview, the XDK is approved for shipping.
