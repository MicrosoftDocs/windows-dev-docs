...
Please note that the MatchSim and XboxLiveCompute tools included in the download require you to be a managed developer, enrolled in the [ID@Xbox](http://www.xbox.com/Developers/id) program. To learn more about the available developer programs, please refer to the [developer program overview](https://docs.microsoft.com/windows/uwp/xbox-live/developer-program-overview). 
