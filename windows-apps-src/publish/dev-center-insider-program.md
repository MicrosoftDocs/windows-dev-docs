...
|--------------------------------------|------------------------------------|------------|
|**More flexibility associating Azure AD tenants with your Dev Center account**: Associate multiple Azure AD tenants with a single Dev Center account, or associate a single Azure AD tenant with more than one Dev Center account.  | In **Account settings**, go to **Manage users**. You’ll see a **Manage Azure AD tenants** page, where you’ll have the option to add additional Azure AD tenants to your account.  | August 2017|
