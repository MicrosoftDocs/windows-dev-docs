...
In this report, an **acquisition** means a new customer has obtained a license to your app (whether you charged money or you've offered it for free). An **install** refers to the app being installed on a Windows 10/11 device.
...
-   **Installs on non-Windows 10/11 devices.** If your app supports earlier OS versions such as Windows 8.x or Windows Phone 8.x, we don't count any installs on those devices.
...
> [!IMPORTANT]
> The **Acquisition funnel** shows data only for customers on Windows 10/11 (including Xbox) over the last 90 days.
