...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Acquisitions</b>     </td><td>    Can view the <a href="acquisitions-report.md">Acquisitions</a> and <a href="add-on-acquisitions-report.md">Add-on acquisitions</a> reports for the product.        </td><td>    N/A    </td><td>    N/A (settings for parent product include the **Add-on acquisitions** report)        </td><td>    N/A                         </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Age ratings</b>    </td><td>    Can view the <a href="age-ratings.md">Age ratings</a> page of product submissions.       </td><td>    Can view and edit the <a href="age-ratings.md">Age ratings</a> page of product submissions.    </td><td>    Can view the Age ratings page of add-on submissions.          </td><td>     Can view and edit the Age ratings page of add-on submissions.       </td></tr>
