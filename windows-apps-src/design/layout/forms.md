...
![settings page](../controls-and-patterns/images/control-examples/toggle-switch-news.png)

Use an instantly updating form when you want users to immediately see the results of changing the values in the form. For example, in settings pages, the current selections are displayed, and any changes made to the selections are applied immediately. To acknowledge the changes in your app, you will need to [add an event handler](../controls-and-patterns/controls-and-events-intro.md) to each input control. If a user changes an input control, then your app can respond appropriately.
...
### Labels
[Labels](../controls-and-patterns/labels.md) should be left-aligned and placed above the input control. Many controls have a built-in Header property that to display the label. For controls that don't have a Header property, or to label groups of controls, you can use a [TextBlock](https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Controls.TextBlock) instead.
...
![forms groups](../controls-and-patterns/images/forms-groups.png)
...
![forms focus](../controls-and-patterns/images/forms-focus2.png)
...
![tab focus on control in form](../controls-and-patterns/images/forms-focus1.png)
...
Control | Use | Example
 - | - | -
[TextBox](../controls-and-patterns/text-box.md) | Capture one or multiple lines of text | Names, free form responses or feedback
[PasswordBox](../controls-and-patterns/password-box.md) | Collect private data by concealing the characters | Passwords, Social Security Numbers (SSN), PINs, credit card information 
[AutoSuggestBox](../controls-and-patterns/auto-suggest-box.md) | Show users a list of suggestions from a corresponding set of data as they type | Database search, mail to: line, previous queries
[RichEditBox](../controls-and-patterns/rich-edit-box.md) | Edit text files with formatted text, hyperlinks, and images | Upload file, preview, and edit in app

### Selection
Control | Use | Example
- | - | - 
| [CheckBox](../controls-and-patterns/checkbox.md) | Select or deselect one or more action items | Agree to terms and conditions, add optional items, select all that apply
[RadioButton](../controls-and-patterns/radio-button.md) | Select one option from two or more choices | Pick type, shipping method, etc.
[ToggleSwitch](../controls-and-patterns/toggles.md) | Choose one of two mutually exclusive options | On/off
...
Control | Use | Example
- | - | -
[Slider](../controls-and-patterns/slider.md) | Select a number from a range of contiguous numerical values | Percentages, volume, playback speed
[Rating](../controls-and-patterns/rating.md) | Rate with stars | Customer feedback

### Date and Time

Control | Use 
- | - 
[CalendarView](../controls-and-patterns/calendar-view.md) | Pick a single date or a range of dates from an always visible calendar 
[CalendarDatePicker](../controls-and-patterns/calendar-date-picker.md) | Pick a single date from a contextual calendar 
[DatePicker](../controls-and-patterns/date-picker.md) | Pick a single localized date when contextual info isn't important
[TimePicker](../controls-and-patterns/time-picker.md) | Pick a single time value

### Additional Controls 
For a complete list of UWP controls, see [index of controls by function](../controls-and-patterns/controls-by-function.md).
...
This example uses an Acrylic [master/detail](../controls-and-patterns/master-details.md) [list view](../controls-and-patterns/lists.md) and [NavigationView](../controls-and-patterns/navigationview.md) control.
...
This example uses the [Pivot](../controls-and-patterns/tabs-pivot.md) control, [Acrylic](../style/acrylic.md) background, and [CommandBar](../controls-and-patterns/app-bars.md) in addition to input controls.
...
![customer orders database screenshot](images/screenshot2.png)
...
## Related topics
- [Input controls](../controls-and-patterns/controls-and-events-intro.md)
