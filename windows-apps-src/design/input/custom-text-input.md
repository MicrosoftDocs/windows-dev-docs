...
Text ranges and selections are represented by the [**CoreTextRange**](https://docs.microsoft.com/uwp/api/Windows.UI.Text.Core.CoreTextRange) structure which contains two fields:
