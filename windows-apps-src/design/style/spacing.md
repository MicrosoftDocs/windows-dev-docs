...
Use a combination of control size and density to optimize your Windows app application and provide a user experience that is most appropriate for your app's functionality and interaction requirements.
