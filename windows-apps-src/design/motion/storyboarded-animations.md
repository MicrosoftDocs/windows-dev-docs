...
-   [**Double**](https://docs.microsoft.com/dotnet/api/system.double), can be animated with any [**DoubleAnimation**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.DoubleAnimation)
...
There's also a generalized [**Object**](https://docs.microsoft.com/dotnet/api/system.object) animation type for object reference values, which we'll discuss later.
...
-   The animation targets [**Canvas.Left**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.left) or [**Canvas.Top**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.top)
