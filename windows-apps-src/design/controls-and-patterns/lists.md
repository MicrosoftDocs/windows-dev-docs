...
Each of these controls (with the exception of ItemsRepeater) also have built-in behavior to allow for the selection of single or multiple items. The "Selection modes for all collection controls" section at the bottom of this article goes into more detail about how to utilize and customize this built-in behavior. [insert link to selection modes page]
...
## Selection mode for all collection controls
