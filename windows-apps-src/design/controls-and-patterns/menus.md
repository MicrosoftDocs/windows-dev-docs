...
![Example of a typical context menu](images/contextmenu-header.png)
...
![Example of menu in app](images/menu-example.png)
...
![Example of context menu in photo gallery](images/contextmenu-example.png) 
...
![Example context menu with icons](images/contextmenu-header.png)
