...
3.	On the Dashboard, select Create a new app.
 ![wns app registration](images/wns-app-registration.png)
...
![wns reserve product name](images/wns-reserve-product-name.png)
...
3.	On the WNS/MPNS page, click the Live Services site link found under the Windows Push Notification Services (WNS) and Microsoft Azure Mobile Services section.
 ![wns live services](images/wns-live-services.png)
...
The following example shows a successful authentication response, including the access token. For syntax details, see [Push notification service request and response headers](https://docs.microsoft.com/previous-versions/windows/apps/hh465435(v=win.10)).
