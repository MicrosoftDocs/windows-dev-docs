...
If you would rather use raw XML instead of the [Notifications library](https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/), please see [the XML schema](https://docs.microsoft.com/en-us/uwp/schemas/tiles/toastschema/schema-root).
