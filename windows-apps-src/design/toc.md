...
### [Custom keyboard interactions](input/custom-keyboard-interactions.md)
...
## [Pen interactions and Windows Ink](input/pen-and-stylus-interactions.md)
...
## [Touchpad interactions](input/touchpad-interactions.md)
...
## [Handle pointer input](input/handle-pointer-input.md)
