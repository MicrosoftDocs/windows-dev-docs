...
1. Use a `Polygon` element to create a background shape for the exposure slider.
    ...
    The [Windows.UI.Xaml.Shapes namespace](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Shapes) provides seven shapes to choose from. There's an ellipse, a rectangle, and a thing called a Path, which can make any sort of shape--yes, even a unicorn!
