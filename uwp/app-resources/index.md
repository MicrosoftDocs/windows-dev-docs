...
| [Package resource index (PRI) file format](pri-file-format.md) | A package resource index (PRI) file is the binary index of your app's resources. This topic describes what a PRI file contains, how it's structured logically, and how to inspect one. |
