...
1.  In Partner Center, go to the [In-app ads](/windows/apps/publish/in-app-ads) page and [create an ad unit](set-up-ad-units-in-your-app.md#live-ad-units). For the ad unit type, specify **Banner**. Make note of both the ad unit ID and the application ID.
    > [!NOTE]
