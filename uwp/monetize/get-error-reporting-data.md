...
| osVersion       | string  | One of the following strings that specifies the OS version on which the error occurred:<ul><li>**Windows Phone 7.5**</li><li>**Windows Phone 8**</li><li>**Windows Phone 8.1**</li><li>**Windows Phone 10**</li><li>**Windows 8**</li><li>**Windows 8.1**</li><li>**Windows 10**</li><li>**Windows 11**</li><li>**Unknown**</li></ul>  |
