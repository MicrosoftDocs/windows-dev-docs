...
This method returns the same data that is provided by the [Ad campaign report](/windows/apps/publish/advertising-performance-report) in Partner Center. For more information about ad campaigns, see [Create an ad campaign for your app](./index.md).
