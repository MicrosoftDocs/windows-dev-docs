...
[Usage guidelines](/windows/apps/design/controls/infobar)

[API reference](/windows/winui/api/microsoft.ui.xaml.controls.infobar)

### Determinate ProgressRing

The determinate state for [ProgressRing](/windows/apps/design/controls/progress-controls) shows the percentage completed of a task. This should be used during an operation where the duration is known and where the operation's progress should not block user interaction with the app.
...
[Usage guidelines](/windows/apps/design/controls/progress-controls#progress-controls-best-practices)
...
[Usage guidelines](/windows/apps/design/controls/navigationview?#footer-menu-items)
