---
title: Create an NFC Smart Card app (archived)
description: Archived content. This topic describes how to use Host Card Emulation (HCE) on Windows 10 Mobile to communicate directly with a near-field communication (NFC) card reader.
ms.date: 03/24/2026
ms.topic: article
keywords: windows 10, uwp, archive, nfc, host card emulation, hce
ms.localizationpriority: low
---

# Create an NFC Smart Card app (archived)

> [!WARNING]
> This content is archived. It applies to Windows 10 Mobile only, which was discontinued in December 2019. This content is no longer maintained.
