...
| [Launch the Default Apps settings page](launch-default-apps-settings.md) | Learn how to launch the Windows Settings app to display the Default Apps settings page from your app using the `ms-settings` URI scheme and, optionally, navigate directly to the settings for a specified default application. |
...
| [Create and register a COM background task for a Win32 app](create-and-register-a-winmain-background-task.md) | Create a COM background task that can run in your main process or out-of-process when your packaged Win32 app may not be running. |
