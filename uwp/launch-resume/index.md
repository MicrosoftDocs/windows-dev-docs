...
| [Launch Windows Settings](/windows/apps/develop/launch/launch-settings) | Learn how to launch Windows Settings from your app. This topic describes the ms-settings URI scheme. Use this URI scheme to launch Windows Settings to specific settings pages. |
