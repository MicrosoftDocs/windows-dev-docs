...
| [Optimize your XAML layout](/windows/apps/develop/performance/optimize-xaml-layout) | Layout can be an expensive part of a XAML app—both in CPU usage and memory overhead. Here are some simple steps you can take to improve the layout performance of your XAML app. | 
