...
:::image type="content" source="./images/list-name.png" alt-text="Screenshot of using the winget list command to find all installed applications with the name git." lightbox="./images/list-name.png":::
...
:::image type="content" source="./images/list-details.png" alt-text="Screenshot of winget list --id Microsoft.VisualStudioCode --details to display details about the installed application." lightbox="./images/list-details.png":::
