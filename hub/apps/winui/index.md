...
> [!Important]
> At this time, there are two generations of the Windows UI Library (WinUI): [WinUI 2 for UWP](winui2/index.md) and [WinUI in the Windows App SDK (WinUI 3)](winui3/index.md). While both can be used in production-ready apps on Windows 10 and later, each have different development targets.
>
