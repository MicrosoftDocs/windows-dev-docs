...
**Release notes:** For more details on the Windows App SDK, see [Latest stable channel release notes for the Windows App SDK](../../windows-app-sdk/stable-channel.md).
