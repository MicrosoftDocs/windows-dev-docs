...
> [!IMPORTANT]
> This article shows how to customize the title bar for apps that use the Windows App SDK, either with or without WinUI. For apps that use UWP and WinUI for UWP, see [Title bar customization](/windows/uwp/ui-input/title-bar) for UWP.
