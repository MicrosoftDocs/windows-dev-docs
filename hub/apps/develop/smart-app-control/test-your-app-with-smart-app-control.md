...
> [!IMPORTANT]
> Controlling Smart App Control can be manually controlled via the Registry **for testing purposes only.** Editing Smart App Control settings in this way could compromise the protection it provides.
