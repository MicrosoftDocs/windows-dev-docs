...
description: This section includes topics that explain the XAML framework and programming concepts for WinUI 3 / Windows App SDK and UWP apps.
title: XAML platform
ms.date: 07/27/2026
ms.topic: article
...
These XAML programming concepts (the XAML language, dependency properties, attached properties, and events and routed events) apply to apps built with the Windows Runtime and XAML. This includes both WinUI 3 / Windows App SDK apps and UWP apps.
