...
| Offline Maps | `ms-settings:maps`<br/>`ms-settings:maps-downloadmaps` (Download maps)<br><br>(**Maps is deprecated. For the latest status and timeline, see [Resources for deprecated features](https://learn.microsoft.com/windows/whats-new/deprecated-features-resources#maps-app).**) |
