...
| Offline Maps | `ms-settings:maps`<br/>`ms-settings:maps-downloadmaps` (Download maps)<br><br>(**Offline maps are unsupported in Maps app since the end of 2023 according to an notification in the app.**<!-- See https://learn.microsoft.com/en-us/answers/questions/3887525/offline-maps-from-settings .-->)<br><br>(**Maps app itself is deprecated and was removed from the Microsoft Store by July 2025.** See [Resources for deprecated features page](https://learn.microsoft.com/en-us/windows/whats-new/deprecated-features-resources#maps-app).) |
