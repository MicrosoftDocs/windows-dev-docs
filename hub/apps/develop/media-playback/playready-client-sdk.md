...
ms.date: 02/24/2026
ms.topic: article
keywords: windows, winui, playready
...
This topic describes how to add PlayReady protected media content to your WinUI app.
...
The following table outlines the mappings between various OPLs in the PlayReady license and how PlayReady DRM for Windows enforces them.
...
In previous versions of PlayReady DRM, non-persistent licenses could only be acquired reactively during playback. In the current version, you can acquire non-persistent licenses proactively before playback begins.
...
This section describes how to add secure stop to your WinUI app.
