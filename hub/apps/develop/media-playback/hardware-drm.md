---
description: This topic provides an overview of how to add PlayReady hardware-based digital rights management (DRM) to your WinUI app.
title: Hardware DRM
ms.date: 02/24/2026
ms.topic: article
...
This topic provides an overview of how to add PlayReady hardware-based digital rights management (DRM) to your WinUI app.
...
This topic provides a brief overview of how Windows implements the trusted execution environment (TEE).
