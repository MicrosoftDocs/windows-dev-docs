...
The simplest way to cast media from a WinUI app is to use the built-in casting capability of the [**MediaPlayerElement**](/uwp/api/Windows.UI.Xaml.Controls.MediaPlayerElement) control.
