...
Notifications Visualizer is a new Windows app [in the Store](https://apps.microsoft.com/detail/9nblggh5xsl1) that helps developers design adaptive Live Tiles and interactive toast notifications for Windows 10.
