---
title: Quickstart Push notifications in the Windows App SDK - Unpackaged C++ Console App Example
...
# Quickstart: Push notifications in the Windows App SDK - Unpackaged C++ Console App Example

In this quickstart you will create an unpackaged desktop Windows application that sends and receives push notifications using the [Windows App SDK](../../../windows-app-sdk/index.md), starting from the C++ console app template. If you want a instructions for adding push notifications to an existing project or more step-by-step instructions for the C++ code below, see [Quickstart: Push Notifications in the Windows App SDK](push-quickstart).
