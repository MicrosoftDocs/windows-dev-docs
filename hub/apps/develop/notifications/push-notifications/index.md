...
Push notifications in the [Windows App SDK](../../../windows-app-sdk/index.md) use [Windows Push Notifications Service (WNS)](https://aka.ms/wns) to send rich notifications to Windows apps using Azure App Registration identities.
