...
See the [Windows Push Notification Services (WNS) overview](wns-overview.md) for a conceptual discussion of push notification and WNS concepts, requirements, and operation.
