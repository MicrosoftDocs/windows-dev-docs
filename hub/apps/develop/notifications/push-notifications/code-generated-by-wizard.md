...
**Tip**  For information about how to get help while editing scripts, see [Enabling IntelliSense for server-side JavaScript](https://devblogs.microsoft.com/visualstudio/enabling-intellisense-for-mobile-services-javascript-in-visual-studio/).
