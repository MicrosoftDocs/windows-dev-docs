...
- [Constructing toast content](app-notifications-content.md)
- [Sending an app notification and handling background activation](app-notifications-csharp-legacy.md)
