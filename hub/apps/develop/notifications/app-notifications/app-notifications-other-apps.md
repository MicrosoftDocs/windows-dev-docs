...
That is, if you're *not* developing a packaged app (see [Create a new project for a packaged WinUI desktop app](../../../winui/winui3/create-your-first-winui3-app.md#packaged-create-a-new-project-for-a-packaged-c-or-c-winui-3-desktop-app)),
