...
This article provides design guidance for planning and implementing your app's notification experience, including choosing the right UI elements, managing notification frequency, and handling user interactions. For more information about app notifications, see [App notifications overview](index.md).
...
- [App notifications quickstart](app-notifications-quickstart.md)