...
3. Send your notification ([learn more](app-notifications-csharp-legacy.md))
...
Activation is handled identical to [normal app notification activation](app-notifications-csharp-legacy.md#step-3-handle-activation), meaning you can retrieve these arguments when the user clicks the body of your notification or a button on your notification.

#### [Windows App SDK](#tab/appsdk)

For Windows App SDK apps, activation is handled through the `AppNotificationManager.Default.NotificationInvoked` event. See [Send a local app notification](app-notifications-csharp-legacy.md) to learn more about Windows App SDK notification activation.
