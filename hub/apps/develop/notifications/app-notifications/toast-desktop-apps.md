...
This is the preferred option that works for desktop apps, and supports all notification features. Don't be afraid of the "COM activator"; we have a library [for C#](app-notifications-csharp-legacy.md) and [C++ apps](app-notifications-cpp-wrl-legacy.md) that makes this very straightforward, even if you've never written a COM server before.<br/><br/>
...
To learn how to use this option, see [Send a local app notification from desktop C# apps](app-notifications-csharp-legacy.md) or [Send a local app notification from Win32 C++ WRL apps](app-notifications-cpp-wrl-legacy.md).
