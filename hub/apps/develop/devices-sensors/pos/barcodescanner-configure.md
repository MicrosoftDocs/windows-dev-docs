...
description: This topic describes how barcode scanners can be configured in Windows apps.
ms.date: 05/27/2026
ms.topic: article
---
...
Your barcode scanner manufacturer may also have a vendor specific driver that supports the WinRT Barcode Scanner APIs using a mode other than **HID POS Scanner**. If you have already installed a manufacturer-provided driver compatible with WinRT Barcode Scanner APIs, you may see a vendor-specific device listed under **POS Barcode Scanner** in Device Manager.

## Bluetooth barcode scanner

A Bluetooth connected scanner must be configured in **Serial Port Protocol - Simple Serial Interface (SPP-SSI)** mode to work with the WinRT Barcode Scanner APIs. Please refer to your barcode scanner documentation or contact your barcode scanner manufacturer for instructions to enable the **SPP-SSI mode**.
