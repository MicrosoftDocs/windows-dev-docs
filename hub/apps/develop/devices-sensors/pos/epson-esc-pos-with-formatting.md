...
> [!div class="checklist"]
>
> - **Important APIs:** [PointofService Printer](/uwp/api/Windows.Devices.PointOfService), [Windows.Devices.PointOfService](/uwp/api/Windows.Devices.PointOfService)

## ESC/POS usage

Windows Point of Service supports a variety of printers, including several Epson TM series printers. Windows supports printing through the ESC/POS printer control language, which provides efficient and functional commands for communicating with your printer.
...
For more information on ESC/POS, including available commands, see the [ESC/POS Command Reference Revision 2.60](https://reference.epson-biz.com/modules/ref_escpos/index.php).
