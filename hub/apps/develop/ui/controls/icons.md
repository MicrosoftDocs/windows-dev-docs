...
:::image type="content" source="images/icons-command-bar.png" alt-text="A command bar flyout with icons for add - plus sign, edit - pencil, share - page and arrow, and settings - gear":::
...
:::image type="content" source="images/icon-play-button.png" alt-text="A button with the play icon, an outline of a triangle pointing to the right":::
...
:::image type="content" source="images/icon-play-button-text.png" alt-text="A button with the play icon, an outline of a triangle pointing to the right, with the text play below it":::
...
You also use Symbol names to set an _`icon`_ property in XAML using [attribute syntax](../../platform/xaml/xaml-syntax-guide.md#setting-a-property-by-using-attribute-syntax), like this

```xaml
<AppBarButton Icon="Send" Label="Send"/>
```

:::image type="content" source="images/icon-send.png" alt-text="A button with the send icon, an outline of an arrow head pointing to the right":::

> [!TIP]
> You can only use Symbol names to set an _`icon`_ property using the shortened [attribute syntax](../../platform/xaml/xaml-syntax-guide.md#setting-a-property-by-using-attribute-syntax). All other icon types must be set using the longer [property element syntax](../../platform/xaml/xaml-syntax-guide.md#setting-a-property-by-using-property-element-syntax), as shown in other examples on this page.
...
:::image type="content" source="images/icon-send-fill.png" alt-text="A button with the send fill icon, a filled in arrow head pointing to the right":::
...
:::image type="content" source="images/icon-play-emoji-font.png" alt-text="A button with the play icon from the Segoe UI Emoji font, a white arrow head pointing to the right on a blue background":::
...
:::image type="content" source="images/icon-abstract-path.png" alt-text="A button with a custom path icon":::
:::image type="content" source="images/icon-circles-path.png" alt-text="A button with a custom path icon, two circles around a center point":::

To learn more about using [Geometry](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.media.geometry) classes to create custom shapes, see the class documentation and [Move and draw commands for geometries](../../platform/xaml/move-draw-commands-syntax.md). Also see the [WPF Geometry documentation](/dotnet/desktop/wpf/graphics-multimedia/geometry-overview). The WinUI Geometry class doesn't have all the same features as the WPF class, but creating shapes is the same for both.
...
:::image type="content" source="images/icon-slices-bitmap.png" alt-text="A button with a bitmap icon, pie shaped slices in black and white":::
...
:::image type="content" source="images/icon-slices-image-svg.png" alt-text="A button with an image icon, pie shaped slices in different colors":::
