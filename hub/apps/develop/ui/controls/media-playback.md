...
> [Open the WinUI Gallery app and see the MediaPlayerElement in action](winui3gallery:/item/MediaPlayerElement)
...
- [Content design basics for Windows apps](../../../design/basics/content-basics.md)
