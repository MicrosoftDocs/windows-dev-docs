...
> - [Open the WinUI for UWP Gallery app and see the ComboBox in action](winui2gallery:/item/ComboBox). [!INCLUDE [winui-2-gallery](../../../../includes/winui-2-gallery.md)]
...
[WinUI for UWP.2](/windows/uwp/get-started/winui2/) or later includes a new template for this control that uses rounded corners. For more info, see [Corner radius](../../../design/style/rounded-corner.md).
