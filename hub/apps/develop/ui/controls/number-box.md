...
Here's the XAML for a basic NumberBox that demonstrates the default look. Use [x:Bind](../../platform/xaml/x-bind-markup-extension.md#property-path) to ensure the data displayed to the user remains in sync with the data stored in your app.
