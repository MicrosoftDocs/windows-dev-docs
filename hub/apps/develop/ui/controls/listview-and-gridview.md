...
> [!IMPORTANT]
> When you use the [x:Bind markup extension](../../platform/xaml/x-bind-markup-extension.md) in DataTemplate, you have to specify the data type (`x:DataType`) on the data template.
