...
| [Gaze input](/windows/uwp/design/input/gaze-interactions) | Track a user's gaze based on the location and movement of their eyes and head. |
...
| [Gamepad and remote control](/windows/uwp/design/input/gamepad-and-remote-interactions) | Optimize your app for gamepad and remote control input. |
...
| [Surface Dial](/windows/uwp/design/input/windows-wheel-interactions) | Handle input from the Surface Dial and other wheel devices. |
...
- [Input injection](/windows/uwp/design/input/input-injection)
