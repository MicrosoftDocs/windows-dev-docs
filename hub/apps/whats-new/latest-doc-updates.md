...
* [Porting to C# from C++/WinRT](/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp)
* [Walkthrough: Create a C#/WinRT component and consume it from C++/WinRT](/windows/uwp/csharp-winrt/create-windows-runtime-component-cswinrt)
* [Diagnose C#/WinRT component errors](/windows/uwp/csharp-winrt/authoring-diagnostics)
...
* A rewrite of the Navigation control topics, with C++/ WinRT sample code: 
    * [Navigation history and backwards navigation for Windows apps](/windows/uwp/design/basics/navigation-history-and-backwards-navigation)
    * [Navigation view](/windows/uwp/design/controls-and-patterns/navigationview)
* [High-level shader language (HLSL)](/windows/win32/direct3dhlsl/dx-graphics-hlsl)
* [WinHttpQueryDataAvailable](/windows/win32/api/winhttp/nf-winhttp-winhttpquerydataavailable)
* [Tutorial for using feature flags in a .NET Core app | Microsoft Docs](/azure/azure-app-configuration/use-feature-flags-dotnet-core)
...
* Information on the new [Settings UI](/windows/terminal/customize-settings/startup) in Windows Terminal.
...
<ul>
<li><a href="/windows/uwp/composition/relation-animations">Relation based animations</a></li>
<li><a href="/windows/uwp/cpp-and-winrt-apis/move-to-winrt-from-csharp">Move to C++/WinRT from C#</a></li>
<li><a href="/windows/uwp/csharp-winrt/authoring-diagnostics">Diagnose C#/WinRT component errors</a></li>
<li><a href="/windows/uwp/csharp-winrt/create-windows-runtime-component-cswinrt">Create a C#/WinRT component and consume it from C++/WinRT</a></li>
<li><a href="/windows/uwp/csharp-winrt/index">C#/WinRT</a></li>
<li><a href="/windows/uwp/debug-test-perf/device-portal-api-core">Windows Device Portal core REST API reference</a></li>
<li><a href="/windows/uwp/debug-test-perf/device-portal-desktop">Windows Device Portal for Desktop</a></li>
<li><a href="/windows/uwp/debug-test-perf/device-portal-mobile">Windows Device Portal for Mobile</a></li>
<li><a href="/windows/uwp/debug-test-perf/device-portal">Windows Device Portal overview</a></li>
<li><a href="/windows/uwp/design/app-settings/store-and-retrieve-app-data">Store and retrieve settings and other app data</a></li>
<li><a href="/windows/uwp/design/basics/navigation-history-and-backwards-navigation">Navigation history and backwards navigation</a></li>
<li><a href="/windows/uwp/design/controls-and-patterns/infobar">InfoBar</a></li>
<li><a href="/windows/uwp/design/controls-and-patterns/media-playback">Media players</a></li>
<li><a href="/windows/uwp/design/controls-and-patterns/navigationview">Navigation view</a></li>
<li><a href="/windows/uwp/design/input/cortana-deep-link-into-your-app">Deep link from a background app in Cortana to a foreground app - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-design-guidelines">Cortana design guidelines - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-dynamically-modify-voice-command-definition-vcd-phrase-lists">Dynamically modify Cortana VCD phrase lists - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-interact-with-a-background-app">Interact with a background app in Cortana - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-interactions">Cortana interactions in Windows apps</a></li>
<li><a href="/windows/uwp/design/input/cortana-launch-a-background-app-with-voice-commands">Activate a background app in Cortana using voice commands | Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-launch-a-foreground-app-with-voice-commands">Activate a foreground app with voice commands through Cortana - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/design/input/cortana-support-natural-language-voice-commands">Support more natural voice commands in Cortana - Cortana UWP design and development</a></li>
<li><a href="/windows/uwp/gaming/about-the-uwp-user-interface-and-directx">The app object and DirectX</a></li>
<li><a href="/windows/uwp/graphics-concepts/graphics-pipeline">Graphics pipeline</a></li>
<li><a href="/windows/uwp/monetize/get-the-stack-trace-for-an-error-in-your-desktop-application">Get the stack trace for an error in your desktop application</a></li>
<li><a href="/windows/uwp/monetize/manage-add-on-submissions">Manage add-on submissions</a></li>
<li><a href="/windows/uwp/monetize/manage-add-ons">Manage add-ons</a></li>
<li><a href="/windows/uwp/monetize/manage-app-submissions">Manage app submissions</a></li>
<li><a href="/windows/uwp/monetize/manage-flight-submissions">Manage package flight submissions</a></li>
<li><a href="/windows/uwp/monetize/view-and-grant-products-from-a-service">Manage product entitlements from a service</a></li>
<li><a href="/windows/uwp/publish/set-custom-permissions-for-account-users">Set roles or custom permissions for account users</a></li>
<li><a href="/windows/uwp/xbox-apps/development-lanes-unity-versioning">Unity - Version control your UWP project</a></li>
<li><a href="/windows/uwp/xbox-apps/uwp-deployinfo-api">Device Portal deploy info API reference</a></li>
<li><a href="/windows/uwp/xbox-apps/uwp-networkcredentials-api">Device Portal network credentials API reference</a></li>
<li><a href="/windows/uwp/xbox-apps/uwp-remoteinput-api">Device Portal remote input API reference</a></li>
<li><a href="/windows/uwp/xbox-apps/uwp-remoteinput-controllers-api">Device Portal controllers API reference</a></li>
<li><a href="/windows/uwp/xbox-apps/uwp-sshpins-api">Device Portal SSH pins API reference</a></li>
<li><a href="/windows/uwp/xbox-apps/wdp-media-capture-api">Media Capture API reference</a></li>
</ul>

## Win32 conceptual

<ul>
<li><a href="/windows/desktop/Bits/using-windows-powershell-to-create-bits-transfer-jobs">Using Windows PowerShell to Create BITS Transfer Jobs</a></li>
<li><a href="/windows/desktop/Bits/using-winrm-windows-powershell-cmdlets-to-manage-bits-transfer-jobs">Using WinRM Windows PowerShell Cmdlets to Manage BITS Transfer Jobs</a></li>
<li><a href="/windows/desktop/CIMWin32Prov/win32-optionalfeature">Win32_OptionalFeature class</a></li>
<li><a href="/windows/desktop/CIMWin32Prov/win32-pnpdeviceproperty">Win32_PnPDeviceProperty class</a></li>
<li><a href="/windows/desktop/Controls/toolbar-standard-button-image-index-values">Toolbar Standard Button Image Index Values (CommCtrl.h)</a></li>
<li><a href="/windows/desktop/Direct2D/border">Border effect</a></li>
<li><a href="/windows/desktop/Direct2D/profiling-directx-applications">Profiling DirectX Apps</a></li>
...
<li><a href="/windows/desktop/HyperV_v2/getting-the-virtual-system-dns-name">Getting the virtual machine DNS name</a></li>
<li><a href="/windows/desktop/LearnWin32/appendix--matrix-transforms">Appendix Matrix Transforms</a></li>
<li><a href="/windows/desktop/Midl/-target">/target switch</a></li>
<li><a href="/windows/desktop/Midl/declare-guid">declare_guid attribute</a></li>
...
<li><a href="/windows/desktop/Msi/patching-per-user-managed-applications">Patching Per-User Managed Applications</a></li>
<li><a href="/windows/desktop/Multimedia/buffered-services">Buffered Services</a></li>
<li><a href="/windows/desktop/NDF/using-network-monitor-to-view-etl-files">Using Network Monitor to View ETL Files</a></li>
<li><a href="/windows/desktop/OpenGL/glfogf">glFogf function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glfogfv">glFogfv function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glfogi">glFogi function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glfogiv">glFogiv function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glmap1d">glMap1d function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glmap1f">glMap1f function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glmap2d">glMap2d function (Gl.h)</a></li>
<li><a href="/windows/desktop/OpenGL/glmap2f">glMap2f function (Gl.h)</a></li>
<li><a href="/windows/desktop/ProcThread/using-thread-local-storage">Using Thread Local Storage</a></li>
<li><a href="/windows/desktop/SecAuthN/protocols-in-tls-ssl--schannel-ssp-">Protocols in TLS/SSL (Schannel SSP)</a></li>
<li><a href="/windows/desktop/SecAuthN/schannel-cipher-suites-in-windows-vista">TLS Cipher Suites in Windows Vista</a></li>
<li><a href="/windows/desktop/SecCrypto/alternatives-to-using-capicom">Alternatives to Using CAPICOM</a></li>
<li><a href="/windows/desktop/SecCrypto/cryptuidlgselectcertificate">CryptUIDlgSelectCertificate function</a></li>
<li><a href="/windows/desktop/Sync/synchronization-and-multiprocessor-issues">Synchronization and Multiprocessor Issues</a></li>
<li><a href="/windows/desktop/VDS/volume-and-lun-binding">Volume and LUN Binding</a></li>
<li><a href="/windows/desktop/VSS/setting-vss-restore-methods">Setting VSS Restore Methods</a></li>
<li><a href="/windows/desktop/Win7AppQual/preventing-hangs-in-windows-applications">Preventing Hangs in Windows Applications</a></li>
<li><a href="/windows/desktop/WinProg/large-integer-structures">Large Integer Structures</a></li>
<li><a href="/windows/desktop/WinProg64/shared-registry-keys">Registry Keys Affected by WOW64</a></li>
<li><a href="/windows/desktop/WinRM/winrm-powershell-commandlets">Managed Reference for WinRM Windows PowerShell Command Classes</a></li>
<li><a href="/windows/desktop/WinSock/ipproto-ip-socket-options">IPPROTO_IP socket options</a></li>
<li><a href="/windows/desktop/WinSock/ipproto-ipv6-socket-options">IPPROTO_IPV6 socket options</a></li>
<li><a href="/windows/desktop/WinSock/winsock-ioctls">Winsock IOCTLs (Winsock2.h)</a></li>
<li><a href="/windows/desktop/application-installing-and-servicing">Application Installation and Servicing</a></li>
<li><a href="/windows/desktop/cossdk/configuring-security-for-library-applications">Configuring Security for Library Applications</a></li>
<li><a href="/windows/desktop/delivery_optimization/ibackgroundcopymanager-createjob">IBackgroundCopyManager CreateJob method (Deliveryoptimization.h)</a></li>
<li><a href="/windows/desktop/direct3d12/creating-a-basic-direct3d-12-component">Creating a basic Direct3D 12 component</a></li>
<li><a href="/windows/desktop/direct3d12/d3d12decomposesubresource">D3D12DecomposeSubresource function (D3dx12.h)</a></li>
...
<li><a href="/windows/desktop/direct3d12/dynamic-indexing-using-hlsl-5-1">Dynamic Indexing using HLSL 5.1</a></li>
<li><a href="/windows/desktop/direct3d9/d3dxboxboundprobe">D3DXBoxBoundProbe function (D3DX9Mesh.h)</a></li>
<li><a href="/windows/desktop/direct3dhlsl/dx-graphics-hlsl-state-object">State Objects</a></li>
<li><a href="/windows/desktop/direct3dhlsl/dx-graphics-hlsl">High-level shader language (HLSL)</a></li>
<li><a href="/windows/desktop/directx-sdk--august-2009-">Where is the DirectX SDK?</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/columnvalueofstruct-t-class">ColumnValueOfStruct(T) class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentcorruptionexception-class">EsentCorruptionException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentfatalexception-class">EsentFatalException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentfragmentationexception-class">EsentFragmentationException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentinconsistentexception-class">EsentInconsistentException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentmemoryexception-class">EsentMemoryException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentobsoleteexception-class">EsentObsoleteException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentoperationexception-class">EsentOperationException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentstateexception-class">EsentStateException class</a></li>
<li><a href="/windows/desktop/extensible-storage-engine/esentusageexception-class">EsentUsageException class</a></li>
...
<li><a href="/windows/desktop/lwef/animations">Animations</a></li>
<li><a href="/windows/desktop/lwef/creating-animations">Creating Animations</a></li>
...
<li><a href="/windows/desktop/medfound/direct3d-video-motion-estimation">Direct3D video motion estimation</a></li>
...
<li><a href="/windows/desktop/updateorchestrator/universalorchestrator-iuniversalorchestrator">IUniversalOrchestrator interface</a></li>
...
<li><a href="/windows/desktop/uxguide/cmd-toolbars">Toolbars</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-balloons">Balloons</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-command-buttons">Command Buttons</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-command-links">Command Links</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-drop">Drop-down Lists Combo Boxes</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-group-boxes">Group Boxes</a></li>
<li><a href="/windows/desktop/uxguide/ctrl-search-boxes">Search Boxes</a></li>
<li><a href="/windows/desktop/uxguide/glossary">Glossary (Design basics)</a></li>
<li><a href="/windows/desktop/uxguide/inter-mouse">Mouse and Pointers</a></li>
...
<li><a href="/windows/desktop/uxguide/vis-animations">Animations and Transitions</a></li>
<li><a href="/windows/desktop/uxguide/vis-graphic">Graphic Elements</a></li>
<li><a href="/windows/desktop/uxguide/vis-icons">Icons (Design basics)</a></li>
<li><a href="/windows/desktop/uxguide/vis-std-icons">Standard Icons</a></li>
<li><a href="/windows/desktop/uxguide/win-wizards">Wizards</a></li>
...
<li><a href="/windows/desktop/wcs/about-windows-color-system-version-1-0">About Windows Color System Version 1.0</a></li>
<li><a href="/windows/desktop/wcs/additive-primary-colors">Additive Primary Colors</a></li>
<li><a href="/windows/desktop/wcs/advanced-functions-for-use-outside-of-a-device-context">Advanced Functions for Use Outside of a Device Context</a></li>
<li><a href="/windows/desktop/wcs/alphabetical-list-of-all-wcs-functions">Alphabetical List of All WCS Functions</a></li>
...
<li><a href="/windows/desktop/wcs/basic-functions-for-use-within-a-device-context">Basic Functions for Use Within a Device Context</a></li>
...
<li><a href="/windows/desktop/wcs/color-conversion-and-color-matching">Color Conversion and Color Matching</a></li>
...
<li><a href="/windows/desktop/wcs/device-calibration-and-characterization-functions">Device Calibration and Characterization Functions</a></li>
...
<li><a href="/windows/desktop/wcs/macros-for-cmyk-values-and-colors">Macros for CMYK Values and Colors</a></li>
...
<li><a href="/windows/desktop/wcs/security-considerations--windows-color-system">Security Considerations Windows Color System</a></li>
...
<li><a href="/windows/desktop/wcs/using-color-management-modules--cmm">Using Color Management Modules (CMM)</a></li>
<li><a href="/windows/desktop/wcs/using-color-management-on-the-internet">Using Color Management on the Internet</a></li>
...
<li><a href="/windows/desktop/wcs/using-the-color-mapping-process-with-wcs">Using The Color Mapping Process with WCS</a></li>
...
<li><a href="/windows/desktop/wcs/wcs-color-appearance-model-profile-schema-and-algorithm">WCS Color Appearance Model Profile Schema and Algorithm</a></li>
<li><a href="/windows/desktop/wcs/wcs-color-device-model-profile-schema-and-algorithms">WCS Color Device Model Profile Schema and Algorithms</a></li>
<li><a href="/windows/desktop/wcs/wcs-constants">WCS Constants</a></li>
<li><a href="/windows/desktop/wcs/wcs-functions-for-color-management-modules--cmms--to-implement">WCS Functions for Color Management Modules (CMMs) to Implement</a></li>
<li><a href="/windows/desktop/wcs/wcs-gamut-map-model-profile-schema-and-algorithms">WCS Gamut Map Model Profile Schema and Algorithms</a></li>
<li><a href="/windows/desktop/wcs/wcs-registry-keys">WCS Registry Keys</a></li>
<li><a href="/windows/desktop/wcs/wcs-transform-creation-algorithms">WCS Transform Creation Algorithms</a></li>
<li><a href="/windows/desktop/wcs/what-s-new-in-version-1-0-of-wcs">What's New in Version 1.0 of WCS</a></li>
<li><a href="/windows/desktop/wcs/what-s-new-in-windows-vista">What's New in Windows Vista</a></li>
<li><a href="/windows/desktop/wcs/windows-color-system-common-profile-types-schema--versioning-and-localization-strategies">Windows Color System Common Profile Types schema, Versioning and Localization Strategies</a></li>
<li><a href="/windows/desktop/wcs/windows-color-system-schemas-and-algorithms">Windows Color System Schemas and Algorithms</a></li>
...
<li><a href="/windows/win32/api/commctrl/nf-commctrl-loadiconmetric">LoadIconMetric function (commctrl.h) </a></li>
...
<li><a href="/windows/win32/api/processthreadsapi/nf-processthreadsapi-terminateprocess">TerminateProcess function (processthreadsapi.h) </a></li>
...
<li><a href="/windows/win32/api/shobjidl_core/nf-shobjidl_core-shassocenumhandlers">SHAssocEnumHandlers function (shobjidl_core.h) </a></li>
<li><a href="/windows/win32/api/winbase/nf-winbase-createprocesswithlogonw">CreateProcessWithLogonW function (winbase.h) </a></li>
<li><a href="/windows/win32/api/winbase/nf-winbase-createprocesswithtokenw">CreateProcessWithTokenW function (winbase.h) </a></li>
<li><a href="/windows/win32/api/winsock2/nf-winsock2-recvfrom">recvfrom function (winsock2.h) </a></li>
