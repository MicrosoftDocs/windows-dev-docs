...
This article provides an overview of using background tasks and describes how to create a new background task in a WinUI 3 app. A full WinUI 3 background task registration sample can be found in the [WIndowsAppSDK-Samples GitHub repository](https://github.com/microsoft/WindowsAppSDK-Samples/tree/release/experimental/Samples/BackgroundTask).
