---
title: Enhance UI with the Visual layer (Windows App SDK/WinUI)
...
# Enhance UI with the Visual layer (Windows App SDK/WinUI)
...
To use **Microsoft.UI.Composition** APIs in the Windows App SDK/WinUI:
...
To learn more about the availability of **Microsoft.UI.Composition** in the Windows App SDK/WinUI, see [release channels](release-channels.md).
