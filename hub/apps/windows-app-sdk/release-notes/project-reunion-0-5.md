...
# Overview and release notes: WinUI 3 - Project Reunion 0.5

WinUI 3 is a native user experience (UX) framework for building modern Windows apps.  It ships independently from the Windows operating system as a part of [Project Reunion](../index.md) (now called the **Windows App SDK**).
...
> [!NOTE]
> **Project Reunion** is the previous code name for the [Windows App SDK](../index.md). This documentation still uses **Project Reunion** when referring to previous releases that used this code name.
...
If you created an app with an earlier preview or release version of WinUI 3, you can update the project to use the latest release of WinUI 3 - Project Reunion 0.5. For instructions, see [Update existing projects to the latest release of the Windows App SDK](/previous-versions/windows/app-dev/windows-app-sdk/update-existing-projects-to-the-latest-release).
