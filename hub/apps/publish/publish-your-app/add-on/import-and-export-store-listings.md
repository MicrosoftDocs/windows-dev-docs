---
description: Import and export app add-on store listings so you can reuse them later
title: Import and export store listings for add-on
ms.date: 10/30/2022
ms.topic: article
ms.localizationpriority: medium
---

# Import and export store listings for add-on
