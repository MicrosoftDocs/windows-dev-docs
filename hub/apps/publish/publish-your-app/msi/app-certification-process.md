...
- Make sure that your app's description clearly represents what it does. For help, see our guidance on [writing a great app description](/hub/apps/publish/faq/submit-your-app.md#write-a-great-app-description).
