...
- Make sure that your app's description clearly represents what your app does. For help, see our guidance on [writing a great app description on the best practices section](/hub/apps/publish/faq/submit-your-app.md#write-a-great-app-description).
