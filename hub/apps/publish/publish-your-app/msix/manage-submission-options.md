...
# Manage submission options for MSIX apps
...
In addition, you can add members in either the **Developer** or **Manager** role within your developer account to receive the same notifications or remove those who no longer need to be notified.

To add or remove:

1. On the Submission options page, look for the **Submission notification audience** field.
