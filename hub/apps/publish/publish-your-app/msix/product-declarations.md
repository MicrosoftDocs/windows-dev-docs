...
:::image type="content" source="images/msix-pwa-product-declarations.png" lightbox="images/msix-pwa-product-declarations.png" alt-text="A screenshot of the Properties section where you can provide product declarations for your MSIX app.":::
