...
:::image type="content" source="images/msix-pwa-make-product-unavailable.png" lightbox="images/msix-pwa-make-product-unavailable.png" alt-text="A screenshot of the new msix overview page showing how to make product unavailable in Store":::
...
:::image type="content" source="images/msix-pwa-make-product-available.png" lightbox="images/msix-pwa-make-product-available.png" alt-text="A screenshot of the new msix overview page showing how to make product available in Store":::
