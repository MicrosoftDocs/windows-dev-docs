---
description: Learn how to get started with creating your developer account and submitting your app or game.
title: Get started with Microsoft Store
ms.date: 07/27/2025
...
Publishing your app in the Microsoft Store is the easiest way to reach millions of Windows users with a trusted, secure, and streamlined distribution experience. The Store helps handle installation, updates, and discovery, while giving users confidence through identity, signing, and policy checks. Whether you’re shipping a brand-new app or bringing an existing one to a wider audience, this guide walks you through the key steps to prepare your app, create a Store listing, and submit it for certification.
...
1. **What is the Microsoft Partner Center and why do I need a developer account to publish my app?**
...
2. **What are the main benefits of distributing my app through the Microsoft Store?**
...
3. **How does publishing to the Store improve my app’s trust and security?**
...
4. **What revenue and commerce options are available if I publish to the Store?**
...
5. **What analytics and insights can I access after publishing my app?**
...
6. **How does the Store support enterprise distribution and management?**
...
7. **What are the different types of apps that can be distributed on Store?**
...
8. **What are the Microsoft Store Policies and why do they matter for my app?**
      ...
      Violations can result in failed submissions or removal from the Store. Review the [Microsoft Store Policies](./store-policies.md) to ensure that your app complies with the latest requirements.

9. **How do I register for a Microsoft Store developer account? What are the main steps?**
      ...
      - **Accept terms and verify your account:** Accept the Microsoft App Developer Agreement and complete the required identity or business verification. The new onboarding flow does not charge a registration fee; see [Steps to open a developer account](./partner-center/open-a-developer-account.md).
...
10. **How can I get help from Microsoft if I run into problems with Partner Center or my app?**
...
11. **Does the Microsoft Store provide code signing for my app? Do I need my own code signing certificate?**
