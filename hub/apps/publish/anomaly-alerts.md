---
description: What’s new - Anomaly Alerts for Health Metrics
title: What’s new - Anomaly Alerts for Health Metrics
ms.date: 11/24/2025
ms.topic: article
keywords: windows 10, windows 11, windows, windows store, store, analytics, insights, health, crash, failure, hang, alerts, 
...
### Getting started 
Anomaly Alerts are automatically enabled for eligible apps, so no action is needed to start receiving alerts. Check your email regularly and use the Partner Center Health dashboard to dive deeper into any reported anomalies. 
