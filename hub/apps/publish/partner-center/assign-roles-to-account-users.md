...
| Developer            | Can upload packages and submit apps and add-ons, and can view the [Usage report](../usage-report) for telemetry details. Can access [Cross-Device Experiences](https://developer.microsoft.com/windows/project-rome) functionality. Can’t view financial info or account settings.   |
