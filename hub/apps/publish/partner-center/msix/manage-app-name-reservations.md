---
description: View the names that you've reserved for your MSIX app, reserve additional names (for other languages or to change your app's name), and delete reserved names that you don't need anymore.
title: Manage app name reservations for MSIX app
ms.date: 10/30/2022
ms.topic: article
ms.localizationpriority: medium
---

# Manage app name reservations for MSIX app
...
For more info about reserving app names, and why a certain name may not be available, see [Create your app by reserving a name](../../publish-your-app/msix/reserve-your-apps-name.md).
