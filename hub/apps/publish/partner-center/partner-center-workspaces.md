...
![Partner Center navigate back](../images/partner-center-navigate-back.png)

## Access Engage features in the new Apps and Games workspace

1. Sign in to Partner Center.
1. Select the Apps and games workspace from the Home page or from the left-navigation menu.
1. On the Apps and games workspace, select the Engage features you want from the left navigation.
    - Create customer groups
    - Create targeted offers

    ![Partner Center Apps and games features](../images/partner-center-apps-games-search.png)
