...
* Average Engagement Duration: Discover how much time, on average, each user spends in your app per session, directly measuring stickiness.
* DAD/MAD Ratio: Assess user stickiness by comparing daily to monthly activity, shown both as a percentage and trend graph.
...
### Navigating and Customizing the Usage dashboard 

* Time range: Use the time range dropdown to view data for 1 month, 3 months, 6 months, or a custom range. This applies across all charts and tables and helps you compare short‑term trends with longer‑term patterns.
* Filters & Customization: Apply filters for Market, Device type, Package version, and OS version to tailor insights.
* Exporting Data: Download charts and tables for custom analysis or offline sharing directly from the dashboard.
* Navigation: Clicking on info icons or chart titles can open deeper health reports or metrics definitions for context and troubleshooting.

### Why This Matters

| **Metric**                   | **What it Solves**                        | **Developer Benefit**                                                        |
| ---------------------------- | ----------------------------------------- |------------------------------------------------------------------------------|
| **Monthly Active Devices**   | Measures reach and user base growth       | Validates adoption and retention                                             |
| **Sessions**                 | Monitors app interaction frequency        | Flags engagement peaks and drops                                             |
| **Engagement Duration**      | Measures average session length           | Highlights feature stickiness                                                |
| **DAD/MAD**                  | Assesses repeat (loyal) user ratio        | Focuses on user loyalty improvement                                          |
| **Cohort Retention**         | Tracks weekly user retention over 90 days | Identifies retention and drop-off                                            |
