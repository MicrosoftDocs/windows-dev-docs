---
description: Learn how to publish your apps and games to the Microsoft Store on Windows.
title: Publish apps & games to Microsoft Store on Windows
ms.date: 07/27/2025
...
For a detailed overview of what Microsoft Store offers, see [Benefits of distributing your apps and games via Microsoft Store](https://go.microsoft.com/fwlink/?linkid=2278501).

> [!NOTE]
> This section highlights recent updates across Microsoft Store documentation. 
> * [Revamped company onboarding experience with zero registration fees (India only)](../publish/whats-new-company-developer.md) 
