...
> [!NOTE]
> You can also programmatically retrieve this data by using the [get app acquisitions](/windows/uwp/monetize/get-app-acquisitions) method in our [analytics REST API](/windows/uwp/monetize/access-analytics-data-using-windows-store-services).
...
> [!NOTE]
> You can also programmatically retrieve this data by using the [get app installs](/windows/uwp/monetize/get-app-installs) method in our [analytics REST API](/windows/uwp/monetize/access-analytics-data-using-windows-store-services).
...
> [!NOTE]
> You can also programmatically retrieve this data by using the [get app acquisition funnel data](/windows/uwp/monetize/get-acquisition-funnel-data) method in our [analytics REST API](/windows/uwp/monetize/access-analytics-data-using-windows-store-services).
...
> [!NOTE]
> You can also programmatically retrieve this data by using the [get app conversions by channel](/windows/uwp/monetize/get-app-conversions-by-channel) method in our [analytics REST API](/windows/uwp/monetize/access-analytics-data-using-windows-store-services).
