...
> [!NOTE]
> In order to get your LOB app, the organization must be located in a [supported market](/windows/whats-new/windows-store-for-business-overview#supported-markets), and you must not have [excluded that market](publish-your-app/market-selection.md?pivots=store-installer-msix) when submitting your app. 
...
> [!NOTE]
> When changing an app to **Retail distribution**, you'll need to complete the [age ratings questionnaire](publish-your-app/age-ratings.md?pivots=store-installer-msix) if you haven't done so already, even if the app will not be available for new acquisitions.
