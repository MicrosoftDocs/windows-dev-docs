...
[!INCLUDE [apps-essentials-overview](../includes/apps-essentials-overview.md)]
...
[Get started with design](./design/index.md)
...
[!INCLUDE [apps-develop-overview](../includes/apps-develop-overview.md)]
...
[Get started with package and deploy](./package-and-deploy/index.md)
...
[Get started with the Microsoft Store](./publish/index.md)
