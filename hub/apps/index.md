...
<h2>Develop for target devices</h2>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Windows-based PCs</h3>
                        <p></p>Build UWP, Win32, WPF, Windows Forms desktop apps for PCs running Windows.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Windows IoT</h3>
                        <p></p>Bring the Internet of Things to life with a rich application experience on Windows 10 IoT Core.</p>
                    </div>
                </div>
            </div>
        </div>
...
<h2>Explore scenarios and features</h2>
<ul class="cardsK panelContent">
    <li>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p></p>Enhance your existing .NET and Win32 apps with the latest features in Windows 10 and the Universal Windows Platform (UWP).</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="//docs.microsoft.com/learn/modules/write-your-first-windows10-app/">Write your first Windows 10 application</a></p>
                        <p><a href="//docs.microsoft.com/learn/modules/create-ui-for-windows-10-apps/">Create a UI for Windows 10 apps</a></p>
                        <p><a href="//docs.microsoft.com/learn/modules/enhance-ui-of-windows-10-app/">Enhance the UI of your Windows 10 app</a></p>
                        <p><a href="//docs.microsoft.com/learn/browse/?products=windows&resource_type=module">Browse all Windows modules</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://developer.microsoft.com/games">Games</a></p>
