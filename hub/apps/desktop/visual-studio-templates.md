...
WinUI 3 includes a VSIX package for Visual Studio 2019 that provides project and item templates that help you get started building apps with a WinUI-based interface. See [Install WinUI 3 Preview 4](../winui/winui3/index.md#install-winui-3-preview-4) for more information about the WinUI 3 VSIX package and the project templates provided.
