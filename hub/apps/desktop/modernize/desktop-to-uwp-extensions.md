...
> [!NOTE]
> The features described in this topic require that your app is packaged (has package identity at runtime). That includes packaged apps (see [Create and run a WinUI 3 project](../../get-started/start-here.md)) and packaged apps with external location (see [Grant package identity by packaging with external location](./grant-identity-to-nonpackaged-apps.md)). Also see [Features that require package identity](./modernize-packaged-apps.md).
