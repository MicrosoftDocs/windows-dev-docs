...
- You can change the [GetTooltip](/windows/win32/api/shobjidl_core/nf-shobjidl_core-iexplorercommand-gettooltip) function to customize the [tooltip](../../develop/ui/controls/tooltips.md) which is displayed when you hover the entry in the context menu.
