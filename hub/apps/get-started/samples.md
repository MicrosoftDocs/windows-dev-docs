...
| [Dynamic Dependencies](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/DynamicDependenciesSample/DynamicDependencies) | Use the [Dynamic Dependecy API](../desktop/modernize/framework-packages/use-the-dynamic-dependency-api.md) to **dynamically load MSIX Framework packages** (like DirectX) instead of including static dependencies directly within your distributed app. This sample demonstrates . |
