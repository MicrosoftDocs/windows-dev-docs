...
|                                                   <pre>         Sample           </pre>                                                   |                                                                                Scenario                                                                                 |
| :---------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|             [Activation sample](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/Samples/AppLifecycle/Activation)             |            **Handle app activation kinds**. <br/>App activation APIs determine how your app handles activation kinds like `Launch`, `File`, and `Protocol`.             |
|           [App Instancing sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/AppLifecycle/Instancing)           | **Determine application instancing behavior**. <br/>App instancing APIs determine whether or not users can run multiple instances of your application at the same time. |
|    [Power Notifications sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/AppLifecycle/StateNotifications)     |                   **Use state notifications**. These APIs allow you to detect when the user's device enters specific states, such as low power mode.                    |
|                [Restart sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/AppLifecycle/Restart)                |                                      **Programatically restart your app**. Restart APIs let you programmatically restart your app.                                      |
|           [Resource Management sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/ResourceManagement)           |              **Tailor your app to the user and device settings**. Resource management APIs allow you to adapt resource utilization to specific situations.              |
|            [Deployment Manager sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/DeploymentManager)            |                                  **Use the DeploymentManager** to ensure that Windows application framework components are up to date.                                  |
...
|                   [Unpackaged sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/Unpackaged)                    |                                       **Deploy a non-MSIX packaged app**, an alternative to packaged app deployment architecture.                                       |
| [Dynamic Dependencies sample](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/DynamicDependenciesSample/DynamicDependencies) |               **Dynamically load MSIX Framework packages** (like DirectX) instead of including static dependencies directly within your distributed app.                |
|           [Push Notifications sample](https://github.com/microsoft/WindowsAppSDK-Samples/blob/main/Samples/Notifications/Push)            |                                                                 **Add push notifications to your app**.                                                                 |
|            [App Notifications sample](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/Samples/Notifications/App)             |                                                                **Add toast notifications to your app**.                                                                 |
|               [Custom Controls sample](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/Samples/CustomControls)               |                                                              **Add custom C#/WinRT controls to your app**.                                                              |
|                    [Windowing sample](https://github.com/microsoft/WindowsAppSDK-Samples/tree/main/Samples/Windowing)                     |                                **Add windowing support to your app** in order to create/hide new windows, customize titlebars, and more.                                |
...
|                                          <span style='width: 200px'>Sample</span>                                           |                                                                         Scenario                                                                          |
| :-------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------: |
