...
An application development platform and application model that uses WinRT APIs to deliver packaged apps. UWP apps run in a sandboxed environment and they inherit the security of the UWP platform. [Learn more about UWP](https://docs.microsoft.com/windows/uwp/).
...
##### WinUI
The Windows UI Library (WinUI) is the modern native user interface (UX) framework for both Windows desktop and UWP applications. [Windows UI Library (WinUI)](https://docs.microsoft.com/windows/apps/winui/). 
