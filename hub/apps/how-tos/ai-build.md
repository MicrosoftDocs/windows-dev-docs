...
> [!NOTE]
> This article focuses on GitHub Copilot and its Windows development tools. If you're new to AI-assisted development, start with [Build a WinUI 3 task app with an AI assistant](../tutorials/winui-ai-assisted/intro.md) to learn a tool-neutral workflow for inspecting and verifying generated code.
