...
- Dock [app bars](../controls-and-patterns/command-bar.md) to the bottom of the window for improved reachability.
...
- Put command elements like [app bars](../controls-and-patterns/command-bar.md) at the top of the app window.
