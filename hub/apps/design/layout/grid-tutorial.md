...
## Prerequisites
- Windows 10 and Microsoft Visual Studio 2015 or later. (Newest Visual Studio recommended for current development and security updates) [Install tools for the Windows App SDK](../../get-started/start-here.md).
