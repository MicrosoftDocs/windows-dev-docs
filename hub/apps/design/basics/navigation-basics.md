...
- Avoid deep navigation hierarchies. If you go beyond two levels of navigation, provide a [breadcrumb bar](../../develop/ui/controls/breadcrumbbar.md) that shows the user where they are and lets them quickly get back out. Otherwise, you risk stranding your user in a deep hierarchy that they will have difficulty leaving.
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**Top navigation**](../../develop/ui/controls/navigationview.md)

Displays a horizontal list of links to pages at the same level. The [NavigationView](../../develop/ui/controls/navigationview.md) control implements the top navigation pattern.
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**Tabs**](../../develop/ui/controls/tab-view.md)

Displays a horizontal set of tabs and their respective content. The [TabView](../../develop/ui/controls/tab-view.md) control is useful for displaying several pages (or documents) while giving the user the capability to rearrange, open, or close tabs.
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**Breadcrumb**](../../develop/ui/controls/breadcrumbbar.md)

Displays a horizontal list of links to pages at each of the higher levels. The [BreadcrumbBar](../../develop/ui/controls/breadcrumbbar.md) control implements the breadcrumb navigation pattern.
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**Left navigation**](../../develop/ui/controls/navigationview.md)
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**List/details**](../../develop/ui/controls/list-details.md)
...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [**Hyperlinks**](../../develop/ui/controls/hyperlinks.md)
