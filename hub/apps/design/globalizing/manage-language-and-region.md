...
Name your resource files, or their folders, with language resource qualifiers. To learn more about resource qualifiers, see [Tailor your resources for language, scale, high contrast, and other qualifiers](../../windows-app-sdk/mrtcore/tailor-resources-lang-scale-contrast.md). A resource file can be an image (or other asset), or it can be a resource container file, such as a *.resw* that contains text strings.
