...
Starting with version 2.2 of [WinUI](/windows/uwp/get-started/winui2/), the default style for many controls has been updated to use rounded corners. These new styles are intended to evoke warmth and trust, and make the UI easier for users to visually process.
