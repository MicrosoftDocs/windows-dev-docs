...
> - If you have the **WinUI 2 Gallery** app installed, click here to [open the app and see the ItemsRepeater in action](winui2gallery:/item/ItemsRepeater). Get the app from the [Microsoft Store](https://www.microsoft.com/store/productId/9MSVH128X2ZT) or get the source code on [GitHub](https://github.com/Microsoft/WinUI-Gallery).
