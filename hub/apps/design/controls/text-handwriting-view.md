...
Customize the built-in handwriting view for ink to text input supported by Windows text controls such as the [TextBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox), [RichEditBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.richeditbox), and controls derived from these such as the [AutoSuggestBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.autosuggestbox).
...
In this example, we disable the handwriting view by setting the [IsHandwritingViewEnabled](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox.ishandwritingviewenabled) ​property of the [TextBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox) control to false. All text controls that support the handwriting view support a similar property.
​
```xaml
...
Here, we show how to use the [PlacementAlignment​](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview.placementalignment) property of a [TextBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox) [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) to specify which anchor on the underlying text control is used to align the handwriting view.
​
```xaml
<TextBox Name="SampleTextBox"​
    Height="50" Width="500" ​
...
If your application already provides robust, custom recognition ​functionality, you can use the [AreCandidatesEnabled](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview.arecandidatesenabled) property to disable the built-in suggestions, as shown in the following example.
...
In this example, we ​listen for the [TextChanged](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox.textchanged) event of a [TextBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox) and apply the user's selected font if the text change originated from the HandwritingView (or a default font, if not).
​
```csharp
...
Composite controls that use the [TextBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.textbox) or [RichEditBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.richeditbox) controls, such as [AutoSuggestBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.autosuggestbox) also support a [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview).

To access the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) in a composite control, use the [VisualTreeHelper](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.media.visualtreehelper) API.

The following XAML snippet displays an [AutoSuggestBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.autosuggestbox) control.
...
In the corresponding code-behind, we show how to disable the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) on the [AutoSuggestBox](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.autosuggestbox).
...
In some cases, you might need to ensure that the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) covers UI elements that it otherwise might not.
...
As the StackPanel is now larger than the TextBox, the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) might not occlude all of the composite cotnrol.
...
To address this, set the PlacementTarget property of the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) to the UI element to which it should be aligned.
...
You can also set the size of the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview), which can be useful when you need to ensure the view doesn't occlude important UI.
...
To do this, we bind the MaxWidth property of the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) to the width of the UI element that it should occlude.
...
The following example shows how to listen for the [Opened](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview.opened), [Closed](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview.closed), and [SizeChanged](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.frameworkelement.sizechanged) events of the [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) to set the position of a [Popup](/windows/windows-app-sdk/api/winrt/microsoft.ui.popups).
...
As with all XAML framework controls, you can customize both the visual structure and visual behavior of a [HandwritingView](/windows/windows-app-sdk/api/winrt/microsoft.ui.xaml.controls.handwritingview) for your specific requirements.
