...
> - [Open the WinUI 3 Gallery app and see the CommandBarFlyout in action](winui3gallery:/item/CommandBarFlyout). [!INCLUDE [winui-3-gallery](../../../includes/winui-3-gallery.md)]
