...
<td>
    <p>If you have the <strong>WinUI 2 Gallery</strong> app installed, click here to <a href="winui2gallery:/item/PersonPicture">open the app and see the PersonPicture in action</a>.</p>
    <ul>
