...
_A negative margin will push the border away from the center of the control, and a positive margin will move the border closer to the center of the control._

To turn off focus visuals on the control entirely, simply disable **UseSystemFocusVisuals**:
