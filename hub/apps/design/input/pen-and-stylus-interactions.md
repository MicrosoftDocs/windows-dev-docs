...
_Surface Pen_ (available for purchase at the [Microsoft Store](https://www.microsoft.com/p/surface-pen/8zl5c82qmg6b)).
...
:::row:::
   :::column:::
      _Using ink in your Windows app_
   :::column-end:::
   :::column:::
      _Use Windows Pen and Ink to build more engaging enterprise apps_
   :::column-end:::
:::row-end:::
