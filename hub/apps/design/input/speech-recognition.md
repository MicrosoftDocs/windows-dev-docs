...
A _constraint_ defines the words and phrases (vocabulary) that an app recognizes in speech input. Constraints are at the core of speech recognition and give your app greater control over the accuracy of speech recognition.
...
Here, we show how to test whether speech input is enabled and open the **Settings** > **Privacy** > **Speech, inking, and typing** page, if not enabled.
