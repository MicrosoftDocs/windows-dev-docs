...
> [!IMPORTANT]
> If you are a desktop application using the Desktop Bridge, you must first perform an extra step as described in [Pin from desktop apps](secondary-tiles-desktop-pinning.md)
