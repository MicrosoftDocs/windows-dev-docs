...
<td>
    <p>If you have the <strong style="font-weight: semi-bold">XAML Controls Gallery</strong> app installed, click here to <a href="xamlcontrolsgallery:/item/BreadcrumbBar">open the app and see the BreadcrumbBar in action</a>.</p>
    <ul>
