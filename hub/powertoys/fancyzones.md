...
:::image type="content" source="images/fancyzones/fancy-zones2.png" alt-text="Screenshot of FancyZones utility showing window zones highlighted on desktop during window dragging operation.":::
...
![Settings for Snapping to Multiple Zones via Keyboard](images/fancyzones/window-snap-multiple-zones-w-keyboard-settings.png)
...
![Two Zones Activation screenshot](images/fancyzones/twozones.png)
...
![FancyZones Settings UI](images/fancyzones/settings.png)
...
![FancyZones Picker Multiple Monitors](images/fancyzones/multimon.png)
...
![FancyZones space around zones screenshot](images/fancyzones/spacearound.png)
...
![FancyZones Table Editor Mode](images/fancyzones/grideditor.png)
...
![FancyZones Window Editor Mode](images/fancyzones/canvaseditor.png)
...
![FancyZones Quick-Swap Layouts settings and usage](images/fancyzones/quickswap.gif)
...
![FancyZones Settings bottom screenshot](images/fancyzones/settings2.png)
