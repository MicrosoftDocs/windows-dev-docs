...
:::image type="content" source="images/general/general.png" alt-text="Screenshot of PowerToys general settings interface showing version updates, administrator mode, and appearance options.":::
...
:::image type="content" source="images/general/settings-search.png" alt-text="A screenshot of the PowerToys Settings search feature.":::
...
:::image type="content" source="images/general/settings-search-results.png" alt-text="A screenshot of the PowerToys Settings Search Results page.":::
...
:::image type="content" source="images/general/shortcut-conflicts.png" alt-text="A screenshot of the PowerToys shortcut conflicts window.":::
