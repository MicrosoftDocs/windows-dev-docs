...
:::row:::
    ...
    :::column-end:::
    :::column span="2":::
        [Advanced Paste](advanced-paste.md) is a tool that enables you to paste the text from your clipboard into any format needed. It can be enhanced with an AI powered option that is 100% opt-in and requires an Open AI key.
    :::column-end:::
:::row-end:::
