...
Now that we know how to present basic markdown content, let's try displaying something more elaborate. 

Command Palette supports [Adaptive Cards](https://adaptivecards.io/), which are a way to create rich, interactive content. This can be useful for creating forms, or for displaying more complex content.
