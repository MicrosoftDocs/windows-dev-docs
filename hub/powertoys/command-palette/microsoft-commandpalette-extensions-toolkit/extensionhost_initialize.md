---
title: ExtensionHost.Initialize(IExtensionHost) Method
description: The Initialize method is called when the extension host is initialized.
ms.date: 2/25/2025
ms.topic: reference
no-loc: [PowerToys, Windows, Insider]
---

# ExtensionHost.Initialize([IExtensionHost](../microsoft-commandpalette-extensions/iextensionhost.md)) Method
