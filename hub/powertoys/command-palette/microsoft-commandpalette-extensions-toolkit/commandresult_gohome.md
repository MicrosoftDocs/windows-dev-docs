...
Note: if the command navigates to another application, the palette's default behavior is to hide itself when it loses focus. That will behave the same as [Dismiss](commandresult_dismiss.md) in that case.
