...
| [RaiseItemsChanged(Int)](contentpage_raiseitemschanged.md) | Raises the **ItemsChanged** event with the specified change type. This method can be used to notify subscribers about changes in the items displayed on the page. |
