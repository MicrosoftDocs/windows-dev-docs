...
description: The IconData class is used to represent icon data in the Command Palette Extensions Toolkit.
ms.date: 2/27/2025
ms.topic: reference
...
The **IconData** class is used to represent icon data in the Command Palette Extensions Toolkit. It provides properties to access the icon data and its associated URI.
