...
An [IFilterItem[]](ifilteritem.md) that contains the list of available filters. Each item in the array represents a filter that can be applied to the items displayed in the Command Palette.
