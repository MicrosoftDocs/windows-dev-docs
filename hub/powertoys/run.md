...
| URI-handler | `//` | `//` to launch your default browser.<br />`// learn.microsoft.com` to have your default browser go to Microsoft Docs.<br />`mailto:` and `ms-settings:` links are supported. |
