...
| Time and date                                                                        | `(`                       | `( time and date` shows the current time and date in different formats. `( calendar week::04/01/2022` shows the calendar week for the date '04/01/2022'.                                                                                                                                             |
