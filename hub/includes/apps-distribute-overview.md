...
:::row:::
    :::column:::
       [![Developer account icon](../apps/publish/images/tile-account.png)<br>
    ...
    :::column-end:::
    :::column:::
        [![App certification icon](../apps/publish/images/tile-app-certify.png)<br>
...
:::row:::
    :::column:::
       [![App performance icon](../apps/publish/images/tile-monitor-performance.png)<br>
    ...
    :::column-end:::
    :::column:::
       [![App management icon](../apps/publish/images/tile-app-manage.png)<br>
    ...
    :::column-end:::
    :::column:::
        [![Developer tools icon](../apps/publish/images/tile-tools.png)<br>
...
:::row:::
    :::column:::
       [![Account management icon](../apps/publish/images/tile-manage-account.png)<br>
    ...
    :::column-end:::
    :::column:::
       [![Store policies icon](../apps/publish/images/tile-policy.png)<br>
