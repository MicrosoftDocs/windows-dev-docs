...
- [Build an AI web app by using Python and Flask](/training/modules/python-flask-build-ai-web-app): Use Python, Flask, and Azure Cognitive Services to build a web app that incorporates AI.
