...
> [!TIP]
> If you'd like to edit these settings using the settings UI, you will have to add the `"openSettings"` action to your `"actions"` array in order to open it with the command palette or keyboard.<br \>
> **Note:** This is only available in [Windows Terminal Preview](https://aka.ms/terminal-preview).<br \>
