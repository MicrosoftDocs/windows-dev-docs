...
- If this is the first time you've published the app, and you specified a **Release date** in the [Schedule](./configure-release-schedule.md) section, the app will become available according to your **Release date** selections.
