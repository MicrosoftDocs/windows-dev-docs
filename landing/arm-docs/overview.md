...
:::row:::
    ...
    :::column span="2":::
        ...
        - **[Test Base for Microsoft 365](https://www.microsoft.com/en-us/testbase)** added support for Arm64, it’s easier for you to ensure your applications will work across a broader range of devices and releases by execute test run against all Windows OSes. See [Announcing Windows 11 Arm Private Preview for Test Base - Microsoft Community Hub](https://techcommunity.microsoft.com/t5/windows-it-pro-blog/announcing-windows-11-arm-private-preview-for-test-base/ba-p/3876380), and [sign up for the Arm private preview](https://forms.office.com/pages/responsepage.aspx?id=v4j5cvGGr0GRqy180BHbR8h5ixgVgMhNopWzBv8BM05UQ1lFTEVBU044SU45T1I4NURYQlBEVjdDUiQlQCN0PWcu). 
    :::column-end:::
:::row-end:::
